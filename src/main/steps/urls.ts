...
export const SIGNED_OUT: PageLink = '/signed-out';
...
export const C100_SCREENING_QUESTIONS_PERMISSIONS_WHY_REMOVE: PageLink = `${C100_SCREENING_QUESTIONS_PERMISSIONS_WHY}/:removeFileId?`;
