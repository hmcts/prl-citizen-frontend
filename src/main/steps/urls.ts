...
export const C100_MIAM_UPLOAD_EVIDENCE_FOR_ATTENDING: PageLink = `${C100_MIAM}/upload-evidence-of-attending-miam-or-ncdr/:removeFileId?`;
export const C100_MIAM_PREVIOUS_MIAM_ATTENDANCE_OR_NCDR: PageLink = `${C100_MIAM}/previous-miam-attendance-or-ncdr`;
...
export const STAYING_IN_REFUGE: PageLink = `/:root/${REFUGE_BASE_URL}/staying-in-refuge/:applicantId?`;
export const REFUGE_KEEPING_SAFE: PageLink = `/:root/${REFUGE_BASE_URL}/keeping-details-safe/:applicantId?`;
export const REFUGE_UPLOAD_DOC: PageLink = `/:root/${REFUGE_BASE_URL}/upload-refuge-doc/:removeFileId?`;
export const C100_REFUGE_UPLOAD_DOC: PageLink = `/:root/${REFUGE_BASE_URL}/upload-refuge-doc/:applicantId/:removeFileId?`;
export const REFUGE_DOC_ALREADY_UPLOADED: PageLink = `/:root/${REFUGE_BASE_URL}/c8-already-uploaded/:applicantId?`;
