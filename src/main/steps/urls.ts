...
const REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL = 'reasonable-adjustments';
/** common component related end points */
export const REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_GUIDANCE_PAGE: PageLink = `/:partyType/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/guidance`;
export const REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_LAUNCH: PageLink = `/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/launch`;
...
export const REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_CALLBACK_URL = `:baseUrl/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/callback/:id`;
export const REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_SIGN_OUT_URl = `:baseUrl${SIGN_OUT_URL}`;
export const REASONABLE_ADJUSTMENTS_BACK_URL: PageLink = `/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/back`;
export const REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_HEALTH_CHECK_URL = ':baseUrl/health';
export const REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_CONFIRMATION_PAGE: PageLink = `/:partyType/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/confirmation`;
export const REASONABLE_ADJUSTMENTS_RETRIEVE_SUPPORT_FLAGS = ':baseUrl/:caseId/retrieve-ra-flags/:partyId';
export const REASONABLE_ADJUSTMENTS_REQUEST_SUPPORT_FLAGS = ':baseUrl/:caseId/:eventId/party-create-ra';
export const REASONABLE_ADJUSTMENTS_MANAGE_SUPPORT_FLAGS = ':baseUrl/:caseId/:eventId/party-update-ra';
/** RA local component related end points */
export const REASONABLE_ADJUSTMENTS_ATTENDING_COURT: PageLink = `/:root/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/attending-court`;
export const REASONABLE_ADJUSTMENTS_LANGUAGE_REQUIREMENTS: PageLink = `/:root/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/language-requirements`;
export const REASONABLE_ADJUSTMENTS_SPECIAL_ARRANGEMENTS: PageLink = `/:root/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/special-arrangements`;
export const REASONABLE_ADJUSTMENTS_SUPPORT_DURING_CASE: PageLink = `/:root/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/support-during-your-case`;
export const REASONABLE_ADJUSTMENTS_DOCUMENTS_SUPPORT: PageLink = `/:root/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/documents-support`;
export const REASONABLE_ADJUSTMENTS_COMMUNICATION_HELP: PageLink = `/:root/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/communication-help`;
export const REASONABLE_ADJUSTMENTS_SUPPORT_FOR_HEARING: PageLink = `/:root/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/support-for-court-hearing`;
export const REASONABLE_ADJUSTMENTS_NEEDS_FOR_HEARING: PageLink = `/:root/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/needs-during-court-hearing`;
export const REASONABLE_ADJUSTMENTS_COURT_NEEDS: PageLink = `/:root/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/needs-in-court`;
export const REASONABLE_ADJUSTMENTS_RESPONDENT_RESPONSE_REVIEW: PageLink = `/:root/${REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL}/review`;
...
export const SAFEGAURD_EXCLUDE_URLS = [
  ...
  REASONABLE_ADJUSTMENTS_COMMON_COMPONENT_BASE_URL,
  DOCUMENT_MANAGER,
