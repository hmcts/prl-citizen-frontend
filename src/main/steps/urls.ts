...
export const C100_COMPLETE_YOUR_APPLICATION_GUIDANCE_PAPER_FORM: PageLink = `${C100_COMPLETE_YOUR_APPLICATION_GUIDANCE}/paper-form`;
export const C100_COMPLETE_YOUR_APPLICATION_GUIDANCE_LEGAL_REPRESENTATIVE_14: PageLink = `${C100_COMPLETE_YOUR_APPLICATION_GUIDANCE}/legal-representative-14`;
export const C100_COMPLETE_YOUR_APPLICATION_GUIDANCE_LEGAL_REPRESENTATIVE_CONTACT: PageLink = `${C100_COMPLETE_YOUR_APPLICATION_GUIDANCE}/contact-representative`;
