...
export const C100_C1A_SAFETY_CONCERNS_ORDERS_REQUIRED: PageLink = `${C100_URL}/safety-concerns/orders-required`;
export const C100_C1A_SAFETY_CONCERNS_ORDERS_REQUIRED_ORDERS: PageLink = `${C100_C1A_SAFETY_CONCERNS_ORDERS_REQUIRED}/orders-required`;
