...
/* view all documents */
/* Applicant Documents */
export const APPLICANT_CA_REQUEST: PageLink = `${VIEW_ALL_DOCUMENTS}/carequest`;
...
export const APPLICANT_WITNESS_STATEMENTS: PageLink = `${VIEW_ALL_DOCUMENTS}/witnessstatement`;
