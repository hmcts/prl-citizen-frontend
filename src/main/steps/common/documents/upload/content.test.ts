...
const cyContent = {
  ...
  uploadDocuments: {
    ...
    documentCategoryLabels: {
      ...
      sumbitAWPApplication: 'Cyflwyno cais',
  ...
  viewDocuments: {
    title: 'Gweld yr holl ddogfennau',
    documentSectionTitles: {
      applicationPacks: 'Pecynnau cais',
      ordersFromTheCourt: 'Gorchmynion gan y llys',
      applicantsDocuments: 'Dogfennau’r Ceisydd',
      respondentsDocuments: "Dogfennau'r Atebydd",
      attendingTheHearing: 'Manylion y gwrandawiad',
      otherDocuments: 'Dogfennau eraill',
    },
    documentCategoryLabels: {
      viewAllOrders: 'Gorchmynion gan y llys',
      packServed: 'Eich pecyn cais a gyflwynwyd',
      packToBeServed: 'Pecyn cais i’w gyflwyno ar yr atebydd',
      viewApplicantsDocuments: 'Dogfennau’r ceisydd',
      viewRespondentsDocuments: 'Dogfennau’r atebydd',
      viewAttendingTheHearing: 'Manylion y gwrandawiad',
      viewOtherDocuments: 'Dogfennau eraill',
    },
  },
};
