...
export enum NotificationType {
  ...
  VIEW_RESPONDENT_AOH = 'viewRespondentAOH',
  VIEW_RESPONDENT_RESPONSE_AOH = 'viewRespondentResponseAOH',
...
export enum NotificationID {
  ...
  VIEW_RESPONDENT_AOH = 'CAN6A_VIEW_C1A_RESPONSE_APPLICANT',
  VIEW_RESPONDENT_RESPONSE_AOH = 'CAN6B_VIEW_C1AR_RESPONSE_APPLICANT',
