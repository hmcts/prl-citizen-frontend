...
export enum NotificationType {
  ...
  DA_APPLICANT_AFTER_COURT_SERVES_ORDER_TO_RESPONDENT_PERSONALLY = 'daApplicantAfterCourtServesOrderToRespondentPersonally',
}
...
export enum NotificationID {
  ...
  DA_APPLICANT_AFTER_COURT_SERVES_ORDER_TO_RESPONDENT_PERSONALLY = 'DA_APPLICANT_AFTER_COURT_SERVES_ORDER_TO_RESPONDENT_PERSONALLY',
}
