...
export enum NotificationType {
  ...
  DA_APPLICATION_SERVED_BY_COURT_PERSONAL_NONPERSONAL_SERVICE = 'applicationServedByCourtPersonalNonPersonalServiceDA',
}
...
export enum NotificationID {
  ...
  DA_APPLICATION_SERVED_BY_COURT_PERSONAL_NONPERSONAL_SERVICE = 'DN1_SOA_PERSONAL_NON_PERSONAL_APPLICANT',
}
