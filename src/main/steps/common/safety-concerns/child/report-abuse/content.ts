...
import { C1ASafteyConcernsAbuse, Child1, PRL_C1ASafteyConcernsAbuse, YesNoEmpty } from '../../../../../app/case/definition';
...
export const generateFormFields = (
  data: C1ASafteyConcernsAbuse|PRL_C1ASafteyConcernsAbuse,
  childrenData: Child1[]
