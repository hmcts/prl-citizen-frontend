...
const en = (isC100Journey: boolean) => {
  ...
  return {
    ...
    content9: `Special measures can be put in place to keep you separate from the ${otherParty} when you attend court.`,
...
const cy = (isC100Journey: boolean): ReturnType<typeof en> => {
  ...
  return {
    ...
    content9: `Gallwn roi mesurau arbennig mewn lle i’ch cadw chi ar wahân i’r ${otherParty} pan fyddwch yn mynychu’r llys.`,
