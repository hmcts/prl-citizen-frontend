...
const en = {
  ...
  content10:
    'Please say whether there is a need for the court to make any special measures for you or any relevant children to attend court. Special measures can be put in place to keep you separate from the respondent when you attend court.' +
    '\n This can include some of the following measures:',
...
const cy: typeof en = {
  ...
  content10:
    'Dywedwch a oes angen i’r llys wneud unrhyw drefniadau arbennig i chi neu unrhyw blant perthnasol fynychu’r llys. Gellir rhoi mesurau arbennig ar waith i’ch cadw ar wahân i’r atebydd pan fyddwch yn mynychu’r llys.' +
    '\n Gall hyn gynnwys rhai o’r mesurau canlynol:',
  specialArrangementsList: [
    {
