...
const cy: typeof en = {
  ...
  exitPageSurveyContent:
    'Complete this short, 5-minute survey to help improve our services for you and others. - welsh<div><a class="govuk-notification-banner__link" href="{exitPageSurveyUrl}" target="_blank">Please leave your feedback here(opens in a new tab) - welsh</a>.</div>',
};
