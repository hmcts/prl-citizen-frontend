...
const enContent = {
  ...
  describe('address details', () => {
    ...
    test('should return correct english content', () => {
      ...
      expect(generatedContent.errors.citizenUserFirstNames.required).toEqual(enContent.errors.citizenUserFirstNames.required);
      expect(generatedContent.errors.citizenUserLastNames.required).toEqual(enContent.errors.citizenUserLastNames.required);
      expect(generatedContent.errors.citizenUserPlaceOfBirth.required).toEqual(enContent.errors.citizenUserPlaceOfBirth.required);
      expect(generatedContent.errors.citizenUserDateOfBirth.invalidDate).toEqual(enContent.errors.citizenUserDateOfBirth.invalidDate);
      expect(generatedContent.errors.citizenUserDateOfBirth.incompleteDay).toEqual(enContent.errors.citizenUserDateOfBirth.incompleteDay);
      expect(generatedContent.errors.citizenUserDateOfBirth.incompleteMonth).toEqual(enContent.errors.citizenUserDateOfBirth.incompleteMonth);
      expect(generatedContent.errors.citizenUserDateOfBirth.incompleteYear).toEqual(enContent.errors.citizenUserDateOfBirth.incompleteYear);
      expect(generatedContent.errors.citizenUserDateOfBirth.invalidDateInFuture).toEqual(enContent.errors.citizenUserDateOfBirth.invalidDateInFuture);
    });
    ...
    test('should return correct welsh content', () => {
      ...
      expect(generatedContentcy.errors.citizenUserFirstNames.required).toEqual(cyContent.errors.citizenUserFirstNames.required);
      expect(generatedContentcy.errors.citizenUserLastNames.required).toEqual(cyContent.errors.citizenUserLastNames.required);
      expect(generatedContentcy.errors.citizenUserPlaceOfBirth.required).toEqual(cyContent.errors.citizenUserPlaceOfBirth.required);
      expect(generatedContentcy.errors.citizenUserDateOfBirth.invalidDate).toEqual(cyContent.errors.citizenUserDateOfBirth.invalidDate);
      expect(generatedContentcy.errors.citizenUserDateOfBirth.incompleteDay).toEqual(cyContent.errors.citizenUserDateOfBirth.incompleteDay);
      expect(generatedContentcy.errors.citizenUserDateOfBirth.incompleteMonth).toEqual(cyContent.errors.citizenUserDateOfBirth.incompleteMonth);
      expect(generatedContentcy.errors.citizenUserDateOfBirth.incompleteYear).toEqual(cyContent.errors.citizenUserDateOfBirth.incompleteYear);
      expect(generatedContentcy.errors.citizenUserDateOfBirth.invalidDateInFuture).toEqual(cyContent.errors.citizenUserDateOfBirth.invalidDateInFuture);
    });
