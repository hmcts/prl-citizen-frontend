...
export const miam_collapse_content_cy = `<div>
            <p>Cyfarfod cyntaf gyda chyfryngwr yw MIAM.</p>
            <p>Bydd y MIAM yn:
            </p><ul>
              <li>para am tua awr</li>
            ...
            <p>Ar ddiwedd y cyfarfod, bydd y cyfryngwr yn dweud wrthych a yw eich achos yn addas ar gyfer cyfryngu. Yna gallwch benderfynu a ydych am fwrw ymlaen, neu archwilio opsiynau eraill.</p>
            <p>Manteision MIAM yw:
            </p><ul>
              <li>llai o straen a phroses gyflymach na mynd i'r llys</li>
              <li>help i wneud trefniadau dros fagu plant, eiddo ac arian</li>
              <li>Mwy o reolaeth dros ddyfodol eich teulu</li>
              <li>help i roi lles eich plant yn gyntaf</li>
              <li>help gyda symud ymlaen i gam nesaf eich bywydau</li>
            </ul><p></p>
