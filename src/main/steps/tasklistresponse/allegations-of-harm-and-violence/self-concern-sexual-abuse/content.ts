...
const en = {
  ...
  title: 'Briefly describe the sexual abuse if you feel able to',
...
const cy: typeof en = {
    ...
    title: 'Briefly describe the sexual abuse if you feel able to - in welsh',
...
export const form: FormContent = {
  fields: {
    selfsexualbehaviourDetails: {
      ...
      selfsexualseekHelpFromPersonOrAgency: {
        type: 'radios',
        classes: 'govuk-radios',
