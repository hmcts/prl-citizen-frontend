...
export const HTMLParser = (keys, FoundElement: ANYTYPE, bodyHtml, userCase, typeOfUser) => {
  bodyHtml = getChildBodyHtml(typeOfUser, bodyHtml, keys, FoundElement, userCase);
...
function getChildBodyHtml(typeOfUser: any, bodyHtml: any, keys: any, FoundElement: any, userCase: any) {
  if (typeOfUser === 'child') {
