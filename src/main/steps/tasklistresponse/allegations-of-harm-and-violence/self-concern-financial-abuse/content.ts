...
const en = {
  ...
  title: 'Briefly describe the financial abuse if you feel able to',
...
const cy: typeof en = {
    ...
    title: 'Briefly describe the financial abuse if you feel able to - in welsh',
...
export const form: FormContent = {
  fields: {
    selffinancialbehaviourDetails: {
      ...
      selffinancialbehaviourStartDate: {
        type: 'textarea',
        labelSize: 's',
      ...
      selffinancialisOngoingBehaviour: {
        type: 'radios',
      ...
      selffinancialseekHelpFromPersonOrAgency: {
        type: 'radios',
        classes: 'govuk-radios',
