...
const en = {
  ...
  title: 'Briefly describe the Emotional abuse if you feel able to',
...
const cy: typeof en = {
    ...
    title: 'Briefly describe the Emotional abuse if you feel able to - in welsh',
...
export const form: FormContent = {
  fields: {
    selfemotionalbehaviourDetails: {
      ...
      selfemotionalbehaviourStartDate: {
        type: 'textarea',
        labelSize: 's',
      ...
      selfemotionalisOngoingBehaviour: {
        type: 'radios',
      ...
      selfemotionalseekHelpFromPersonOrAgency: {
        type: 'radios',
        classes: 'govuk-radios',
