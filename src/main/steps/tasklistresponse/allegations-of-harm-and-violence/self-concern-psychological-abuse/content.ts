...
const en = {
  ...
  title: 'Briefly describe the psychological abuse if you feel able to',
...
const cy: typeof en = {
    ...
    title: 'Briefly describe the psychological abuse if you feel able to - in welsh',
...
export const form: FormContent = {
  fields: {
    selfpsychologicalbehaviourDetails: {
        type: 'textarea',
        labelSize: 's',
      ...
      selfpsychologicalbehaviourStartDate: {
        type: 'textarea',
        labelSize: 's',
      ...
      selfpsychologicalisOngoingBehaviour: {
        type: 'radios',
      ...
      selfpsychologicalseekHelpFromPersonOrAgency: {
        type: 'radios',
        classes: 'govuk-radios',
        ...
        values: [
          {
            ...
            value: YesOrNo.YES,
            subFields: {
              selfpsychologicalseekHelpDetails: {
                type: 'textarea',
