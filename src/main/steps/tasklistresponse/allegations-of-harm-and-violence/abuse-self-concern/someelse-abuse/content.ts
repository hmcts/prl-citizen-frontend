...
const en = {
  ...
  title: 'Briefly describe the abuse if you feel able to',
...
const cy: typeof en = {
    ...
    title: 'Briefly describe the abuse if you feel able to - in welsh',
...
export const form: FormContent = {
  fields: {
    selfsomeelsebehaviourDetails: {
      ...
      selfsomeelsebehaviourStartDate: {
        type: 'textarea',
        labelSize: 's',
      ...
      selfsomeelseisOngoingBehaviour: {
        type: 'radios',
      ...
      selfsomeelseseekHelpFromPersonOrAgency: {
        type: 'radios',
        classes: 'govuk-radios',
