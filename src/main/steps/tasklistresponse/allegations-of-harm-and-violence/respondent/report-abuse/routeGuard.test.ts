...
describe('C1A Saftey Concers respondent report abuse RouteGuard', () => {
  test('Should render the page when the guard validation passes', async () => {
    const req = mockRequest({
      ...
      session: {
        userCase: {
          PRL_c1A_concernAboutRespondent: [PRL_C1AAbuseTypes.PSYCHOLOGICAL_ABUSE, PRL_C1AAbuseTypes.FINANCIAL_ABUSE],
        },
      },
    });
