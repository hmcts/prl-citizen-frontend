...
describe('respondent1Sequence', () => {
  test('should contain 1 entries in respondent 1 screen sequence', () => {
    expect(responseCaseSequence).toHaveLength(53);
    ...
    expect(
      responseCaseSequence[26].getNextStep(
    ...
    expect(responseCaseSequence[30].url).toBe(
    ...
    expect(responseCaseSequence[31].getNextStep({ PRL_c1A_haveSafetyConcerns: YesOrNo.YES })).toBe(
      '/tasklistresponse/allegations-of-harm-and-violence/check-answers-yes'
    );
    expect(responseCaseSequence[31].getNextStep({ PRL_c1A_haveSafetyConcerns: YesOrNo.NO })).toBe(
      '/tasklistresponse/allegations-of-harm-and-violence/check-answers-no'
    );

    expect(responseCaseSequence[32].url).toBe('/tasklistresponse/allegations-of-harm-and-violence/check-answers-yes');
    expect(responseCaseSequence[32].showInSection).toBe('aboutRespondentCase');
    expect(responseCaseSequence[32].getNextStep(PRL_safetyConcernsMockData.session.userCase)).toBe(
      '/tasklistresponse/allegations-of-harm-and-violence/child/concerns-about'
    );

    expect(responseCaseSequence[33].url).toBe('/tasklistresponse/allegations-of-harm-and-violence/check-answers-no');
    ...
    expect(responseCaseSequence[38].showInSection).toBe('c100');
    ...
    expect(responseCaseSequence[42].url).toBe('/tasklistresponse/allegations-of-harm-and-violence/abduction/threats');
    ...
    expect(responseCaseSequence[48].url).toBe('/tasklistresponse/allegations-of-harm-and-violence/check-your-answers');
    ...
    expect(responseCaseSequence[49].url).toBe('/tasklistresponse/allegations-of-harm-and-violence/no-feedback');
    ...
    expect(responseCaseSequence[50].url).toBe('/tasklistresponse/start');
    expect(responseCaseSequence[50].showInSection).toBe('aboutRespondentCase');
    expect(responseCaseSequence[50].getNextStep({})).toBe('/tasklistresponse/summary');

    expect(responseCaseSequence[51].url).toBe('/tasklistresponse/summary');
    expect(responseCaseSequence[51].showInSection).toBe('aboutRespondentCase');
    expect(responseCaseSequence[51].getNextStep({})).toBe('/tasklistresponse/summary-confirmation');

    expect(responseCaseSequence[52].url).toBe('/tasklistresponse/summary-confirmation');
    expect(responseCaseSequence[52].showInSection).toBe('aboutRespondentCase');
    expect(responseCaseSequence[52].getNextStep({ id: '1234' })).toBe('/case/1234');
  });
});
