...
import {
  ...
  C100_C1A_SAFETY_CONCERNS_ORDERS_REQUIRED_ORDERS,
...
export const C100Sequence: Step[] = [
  ...
  {
    url: C100_C1A_SAFETY_CONCERNS_ORDERS_REQUIRED_ORDERS,
    showInSection: Sections.C100,
    getNextStep: () => C100_C1A_SAFETY_CONCERNS_ORDERS_REQUIRED_ORDERS,
  },
];
