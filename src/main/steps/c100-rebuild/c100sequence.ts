...
import {
  ...
  C100_children_DETAILS_ADD,
  C100_children_DETAILS_PERSONAL_DETAILS,
  C100_children_DETAILS_CHILD_MATTERS,
...
export const C100Sequence: Step[] = [
  ...
  {
    url: C100_children_DETAILS_ADD,
    showInSection: Sections.C100,
    getNextStep: () => C100_children_DETAILS_PERSONAL_DETAILS,
  },
  {
    url: C100_children_DETAILS_PERSONAL_DETAILS,
    showInSection: Sections.C100,
    getNextStep: () => C100_children_DETAILS_CHILD_MATTERS,
  },
  {
    url: C100_children_DETAILS_CHILD_MATTERS,
    showInSection: Sections.C100,
    getNextStep: () => C100_children_DETAILS_PARENTIAL_RESPONSIBILITY,
  },
  {
    url: C100_children_DETAILS_PARENTIAL_RESPONSIBILITY,
    showInSection: Sections.C100,
    getNextStep: () => C100_children_FURTHER_INFORMATION,
  },
  {
    url: C100_children_FURTHER_INFORMATION,
    showInSection: Sections.C100,
    getNextStep: () => C100_CONFIDENTIALITY_DETAILS_KNOW,
  },
  {
