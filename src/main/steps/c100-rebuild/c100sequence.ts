...
import {
  ...
  C100_ALTERNATIVE_RESOLUTION_ALTERNATIVE_ROUTES,
  PageLink,
...
export const C100Sequence: Step[] = [
  ...
  {
    url: C100_ALTERNATIVE_RESOLUTION_ALTERNATIVE_ROUTES,
    showInSection: Sections.C100,
    getNextStep: () => C100_ALTERNATIVE_RESOLUTION_ALTERNATIVE_ROUTES,
  },
];
