...
const cy = () => ({
  ...
  paraGraph3:
    "Os ydych ar hyn o bryd yn ymwneud ag achos Trefniadau Plant, achos Camau Gwaharddedig neu achos Gorchymyn Materion Penodol ar gyfer yr un plentyn neu blant, gallwch wneud cais i'r un llys gan ddefnyddio ffurflen C2. Gwnewch yn siŵr eich bod yn nodi rhif yr achos pan fyddwch yn cyflwyno'r ffurflen.",
  ...
  secondList: [
    ...
    'dogfennau ar gyfer y <a href="https://www.gov.uk/litigation-friend/apply" class="govuk-link app-link--inverted" target="_blank" rel="external">cyfaill cyfreitha</a> os yw unrhyw un o\'r bobl sy\'n gwneud y cais o dan 18 oed',
  ],
});
