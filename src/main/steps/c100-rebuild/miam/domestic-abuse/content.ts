      ...
      values: [
        {
          ...
          subFields: {
            miam_domesticAbuse_policeInvolvement: {
              ...
              values: [
                {
                  name: 'miam_domesticAbuse_policeInvolvement',
        ...
        },
        {
          ...
          subFields: {
            miam_domesticAbuse_courtInvolvement: {
              ...
              values: [
                {
                  name: 'miam_domesticAbuse_courtInvolvement',
        ...
        },
        {
          ...
          subFields: {
            miam_domesticAbuse_letterOfBeingVictim: {
              ...
              values: [
                {
                  name: 'miam_domesticAbuse_letterOfBeingVictim',
        ...
        },
        {
          ...
          subFields: {
            miam_domesticAbuse_letterFromAuthority: {
              ...
              values: [
                {
                  name: 'miam_domesticAbuse_letterFromAuthority',
        ...
        },
        {
          ...
          subFields: {
            miam_domesticAbuse_letterFromSupportService: {
              ...
              values: [
                {
                  name: 'miam_domesticAbuse_letterFromSupportService',
