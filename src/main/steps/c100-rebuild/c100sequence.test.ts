...
describe('C100Sequence', () => {
  test('should contain 1 entries in c100 screen sequence', () => {
    expect(C100Sequence).toHaveLength(97);
    ...
    expect(C100Sequence[87].url).toBe('/c100-rebuild/child-details/:childId/live-with');
    ...
    expect(C100Sequence[88].url).toBe('/c100-rebuild/applicant/:applicantId/personal-details');
    expect(C100Sequence[88].showInSection).toBe('c100');
    expect(C100Sequence[88].getNextStep(applicantMockRequest.session.userCase, applicantMockRequest)).toBe(
      '/c100-rebuild/applicant/2732dd53-2e6c-46f9-88cd-08230e735b08/relationship-to-child/7483640e-0817-4ddc-b709-6723f7925474'
    );

    expect(C100Sequence[89].url).toBe('/c100-rebuild/applicant/:applicantId/relationship-to-child/:childId');
    expect(C100Sequence[89].showInSection).toBe('c100');
    ...
    expect(C100Sequence[90].url).toBe('/c100-rebuild/applicant/:applicantId/contact-detail');
    expect(C100Sequence[90].showInSection).toBe('c100');
    ...
    expect(C100Sequence[91].url).toBe('/c100-rebuild/consent-order/upload');
    expect(C100Sequence[91].showInSection).toBe('c100');
    expect(C100Sequence[91].getNextStep({})).toBe('/c100-rebuild/consent-order/upload-confirmation');

    expect(C100Sequence[92].url).toBe('/c100-rebuild/consent-order/upload-confirmation');
    expect(C100Sequence[92].showInSection).toBe('c100');
    expect(C100Sequence[92].getNextStep({})).toBe('/c100-rebuild/hearing-urgency/urgent');

    expect(C100Sequence[93].url).toBe('/c100-rebuild/check-your-answers');
    expect(C100Sequence[93].showInSection).toBe('c100');
    expect(C100Sequence[93].getNextStep({})).toBe('/c100-rebuild/check-your-answers');
  });
});
