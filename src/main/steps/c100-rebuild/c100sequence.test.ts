...
describe('C100Sequence', () => {
  test('should contain 1 entries in c100 screen sequence', () => {
    ...
    expect(C100Sequence[99].getNextStep({})).toBe('/c100-rebuild/check-your-answers');
        ...
        expect(C100Sequence[100].url).toBe('/c100-rebuild/applicant/:applicantId/refuge');
    ...
    expect(C100Sequence[101].url).toBe('/c100-rebuild/applicant/:applicantId/refuge-upload');
    expect(C100Sequence[101].showInSection).toBe('c100');
    expect(C100Sequence[101].getNextStep(applicantMockRequest.session.userCase, applicantMockRequest)).toBe(
      '/c100-rebuild/applicant/2732dd53-2e6c-46f9-88cd-08230e735b08/address/lookup'
    );
    expect(C100Sequence[102].url).toBe('/c100-rebuild/applicant/:applicantId/contact-detail');
    ...
    expect(C100Sequence[103].url).toBe('/c100-rebuild/consent-order/upload');
    expect(C100Sequence[103].showInSection).toBe('c100');
    expect(C100Sequence[103].getNextStep({})).toBe('/c100-rebuild/consent-order/upload-confirmation');

    expect(C100Sequence[104].url).toBe('/c100-rebuild/consent-order/upload-confirmation');
    expect(C100Sequence[104].showInSection).toBe('c100');
    expect(C100Sequence[104].getNextStep({})).toBe('/c100-rebuild/hearing-urgency/urgent');

    expect(C100Sequence[105].url).toBe('/c100-rebuild/check-your-answers');
    expect(C100Sequence[105].showInSection).toBe('c100');
    expect(C100Sequence[105].getNextStep({})).toBe('/c100-rebuild/check-your-answers');
  });
});
