...
describe('C100Sequence', () => {
  test('should contain 1 entries in c100 screen sequence', () => {
    expect(C100Sequence).toHaveLength(98);
    ...
    expect(C100Sequence[34].getNextStep({ miam_attendance: YesOrNo.NO })).toBe(
    ...
    expect(C100Sequence[38].url).toBe('/c100-rebuild/miam/miam-info');
    expect(C100Sequence[38].showInSection).toBe('c100');
    expect(C100Sequence[38].getNextStep({})).toBe('/c100-rebuild/miam/attendance');

    expect(C100Sequence[39].url).toBe('/c100-rebuild/miam/valid-reason');
    expect(C100Sequence[39].showInSection).toBe('c100');
    expect(C100Sequence[39].getNextStep({ miam_validReason: YesOrNo.YES })).toBe('/c100-rebuild/miam/general-reasons');
    expect(C100Sequence[39].getNextStep({ miam_validReason: YesOrNo.NO })).toBe('/c100-rebuild/miam/get-mediator');

    expect(C100Sequence[40].url).toBe('/c100-rebuild/miam/no-need');
    expect(C100Sequence[40].showInSection).toBe('c100');
    expect(C100Sequence[40].getNextStep({})).toBe('/c100-rebuild/other-proceedings/current-previous-proceedings');

    expect(C100Sequence[41].url).toBe('/c100-rebuild/miam/miam-other');
    expect(C100Sequence[41].showInSection).toBe('c100');
    expect(C100Sequence[41].getNextStep(miamMockData.session.userCase)).toBe('/c100-rebuild/miam/get-mediator');

    expect(C100Sequence[42].url).toBe('/c100-rebuild/miam/child-protection');
    expect(C100Sequence[42].showInSection).toBe('c100');
    expect(C100Sequence[42].getNextStep(miamMockData.session.userCase)).toBe('/c100-rebuild/miam/urgency');

    expect(C100Sequence[43].url).toBe('/c100-rebuild/miam/domestic-abuse');
    expect(C100Sequence[43].showInSection).toBe('c100');
    expect(C100Sequence[43].getNextStep(miamMockData.session.userCase)).toBe('/c100-rebuild/miam/child-protection');

    expect(C100Sequence[44].url).toBe('/c100-rebuild/miam/general-reasons');
    expect(C100Sequence[44].showInSection).toBe('c100');
    expect(C100Sequence[44].getNextStep(miamMockData.session.userCase)).toBe('/c100-rebuild/miam/domestic-abuse');

    expect(C100Sequence[45].url).toBe('/c100-rebuild/miam/get-mediator');
    expect(C100Sequence[45].showInSection).toBe('c100');
    expect(C100Sequence[45].getNextStep({})).toBe('/c100-rebuild/miam/get-mediator');

    expect(C100Sequence[46].url).toBe('/c100-rebuild/miam/upload');
    expect(C100Sequence[46].showInSection).toBe('c100');
    expect(C100Sequence[46].getNextStep({})).toBe('/c100-rebuild/miam/upload-confirmation');

    expect(C100Sequence[47].url).toBe('/c100-rebuild/miam/upload-confirmation');
    expect(C100Sequence[47].showInSection).toBe('c100');
    expect(C100Sequence[47].getNextStep({})).toBe('/c100-rebuild/typeoforder/select-courtorder');

    expect(C100Sequence[48].url).toBe('/c100-rebuild/miam/get-doc');
    expect(C100Sequence[48].showInSection).toBe('c100');
    expect(C100Sequence[48].getNextStep({})).toBe('/c100-rebuild/miam/get-doc');

    expect(C100Sequence[49].url).toBe('/c100-rebuild/miam/no-need-with-reasons');
    ...
    expect(C100Sequence[50].url).toBe('/c100-rebuild/hearing-urgency/urgent');
    expect(C100Sequence[50].getNextStep({ hu_urgentHearingReasons: YesOrNo.YES })).toBe(
      '/c100-rebuild/hearing-urgency/urgent-details'
    );
    expect(C100Sequence[50].getNextStep({ hu_urgentHearingReasons: YesOrNo.NO })).toBe(
      '/c100-rebuild/hearing-without-notice/hearing-part1'
    );

    expect(C100Sequence[51].url).toBe('/c100-rebuild/hearing-urgency/urgent-details');
    expect(C100Sequence[51].showInSection).toBe('c100');
    expect(C100Sequence[51].getNextStep({})).toBe('/c100-rebuild/hearing-without-notice/hearing-part1');

    expect(C100Sequence[52].url).toBe('/c100-rebuild/screening-questions/consent-agreement');
    expect(C100Sequence[52].showInSection).toBe('c100');
    expect(C100Sequence[52].getNextStep({ sq_writtenAgreement: YesOrNo.YES })).toBe(
      '/c100-rebuild/typeoforder/select-courtorder'
    );
    expect(C100Sequence[52].getNextStep({ sq_writtenAgreement: YesOrNo.NO })).toBe(
      '/c100-rebuild/screening-questions/alternative-resolution'
    );

    expect(C100Sequence[53].url).toBe('/c100-rebuild/screening-questions/alternative-resolution');
    expect(C100Sequence[53].showInSection).toBe('c100');
    expect(C100Sequence[53].getNextStep({})).toBe('/c100-rebuild/screening-questions/alternative-routes');

    expect(C100Sequence[54].url).toBe('/c100-rebuild/screening-questions/legal-representation');
    expect(C100Sequence[54].showInSection).toBe('c100');
    expect(C100Sequence[54].getNextStep({ sq_legalRepresentation: YesOrNo.YES })).toBe(
      '/c100-rebuild/screening-questions/legal-representation-application'
    );
    expect(C100Sequence[54].getNextStep({ sq_legalRepresentation: YesOrNo.NO })).toBe(
      '/c100-rebuild/screening-questions/permission'
    );

    expect(C100Sequence[55].url).toBe('/c100-rebuild/screening-questions/legal-representation-application');
    expect(C100Sequence[55].showInSection).toBe('c100');
    expect(C100Sequence[55].getNextStep({ sq_legalRepresentationApplication: YesOrNo.YES })).toBe(
      '/c100-rebuild/screening-questions/contact-representative'
    );
    expect(C100Sequence[55].getNextStep({ sq_legalRepresentationApplication: YesOrNo.NO })).toBe(
      '/c100-rebuild/screening-questions/permission'
    );

    expect(C100Sequence[56].url).toBe('/c100-rebuild/screening-questions/permissions-request');
    expect(C100Sequence[56].showInSection).toBe('c100');
    expect(C100Sequence[56].getNextStep({})).toBe('/c100-rebuild/miam/other-proceedings');

    expect(C100Sequence[57].url).toBe('/c100-rebuild/screening-questions/alternative-routes');
    expect(C100Sequence[57].showInSection).toBe('c100');
    expect(C100Sequence[57].getNextStep({})).toBe('/c100-rebuild/screening-questions/legal-representation');

    expect(C100Sequence[58].url).toBe('/c100-rebuild/screening-questions/permissions-why');
    expect(C100Sequence[58].showInSection).toBe('c100');
    expect(C100Sequence[58].getNextStep({})).toBe('/c100-rebuild/screening-questions/permissions-request');

    expect(C100Sequence[59].url).toBe('/c100-rebuild/screening-questions/permission');
    expect(C100Sequence[59].showInSection).toBe('c100');
    expect(C100Sequence[59].getNextStep({ sq_courtPermissionRequired: YesOrNo.YES })).toBe(
      '/c100-rebuild/screening-questions/permissions-why'
    );
    expect(C100Sequence[59].getNextStep({ sq_courtPermissionRequired: YesOrNo.NO })).toBe(
      '/c100-rebuild/miam/other-proceedings'
    );

    expect(C100Sequence[60].url).toBe('/c100-rebuild/screening-questions/contact-representative');
    expect(C100Sequence[60].showInSection).toBe('c100');
    expect(C100Sequence[60].getNextStep({})).toBe('/c100-rebuild/screening-questions/contact-representative');

    // expect(C100Sequence[63].url).toBe('/c100-rebuild/safety-concerns/orders-required/unsupervised');
    // expect(C100Sequence[63].showInSection).toBe('c100');
    // expect(C100Sequence[63].getNextStep({})).toBe('/c100-rebuild/international-elements/start');
    ...
    expect(C100Sequence[70].url).toBe('/c100-rebuild/child-details/has-other-children');
    expect(C100Sequence[70].showInSection).toBe('c100');
    expect(C100Sequence[70].getNextStep({ ocd_hasOtherChildren: YesOrNo.NO })).toBe(
      '/c100-rebuild/applicant/add-applicants'
    );
    expect(C100Sequence[70].getNextStep({ ocd_hasOtherChildren: YesOrNo.YES })).toBe(
      '/c100-rebuild/child-details/other-children/names'
    );

    expect(C100Sequence[71].url).toBe('/c100-rebuild/child-details/other-children/names');
    expect(C100Sequence[71].showInSection).toBe('c100');
    expect(C100Sequence[71].getNextStep(otherChildrenMockData.session.userCase, otherChildrenMockData)).toBe(
      '/c100-rebuild/child-details/other-children/c9f56483-6e2d-43ce-9de8-72661755b87c/personal-details'
    );

    expect(C100Sequence[72].url).toBe('/c100-rebuild/child-details/other-children/:childId/personal-details');
    expect(C100Sequence[72].showInSection).toBe('c100');
    expect(C100Sequence[72].getNextStep(otherChildrenMockData.session.userCase, otherChildrenMockData)).toBe(
      '/c100-rebuild/applicant/add-applicants'
    );

    expect(C100Sequence[73].url).toBe('/c100-rebuild/respondent-details/add-respondents');
    expect(C100Sequence[73].showInSection).toBe('c100');
    expect(C100Sequence[73].getNextStep(respondentMockData.session.userCase)).toBe(
      '/c100-rebuild/respondent-details/2732dd53-2e6c-46f9-88cd-08230e735b08/personal-details'
    );

    expect(C100Sequence[74].url).toBe('/c100-rebuild/respondent-details/:respondentId/personal-details');
    expect(C100Sequence[74].showInSection).toBe('c100');
    expect(C100Sequence[74].getNextStep(respondentMockData.session.userCase, respondentMockData)).toBe(
    ...
    expect(C100Sequence[75].url).toBe('/c100-rebuild/respondent-details/:respondentId/relationship-to-child/:childId');
    expect(C100Sequence[75].showInSection).toBe('c100');
    expect(C100Sequence[75].getNextStep(respondentMockData.session.userCase, respondentMockData)).toBe(
      '/c100-rebuild/respondent-details/2732dd53-2e6c-46f9-88cd-08230e735b08/address/lookup'
    );

    expect(C100Sequence[76].url).toBe('/c100-rebuild/respondent-details/:respondentId/address/lookup');
    expect(C100Sequence[76].showInSection).toBe('c100');
    expect(C100Sequence[76].getNextStep(respondentMockData.session.userCase, respondentMockData)).toBe(
      '/c100-rebuild/respondent-details/2732dd53-2e6c-46f9-88cd-08230e735b08/address/select'
    );

    expect(C100Sequence[77].url).toBe('/c100-rebuild/respondent-details/:respondentId/address/select');
    expect(C100Sequence[77].showInSection).toBe('c100');
    expect(C100Sequence[77].getNextStep(respondentMockData.session.userCase, respondentMockData)).toBe(
      '/c100-rebuild/respondent-details/2732dd53-2e6c-46f9-88cd-08230e735b08/address/manual'
    );

    expect(C100Sequence[78].url).toBe('/c100-rebuild/respondent-details/:respondentId/address/manual');
    ...
    expect(C100Sequence[79].url).toBe('/c100-rebuild/respondent-details/:respondentId/contact-details');
    ...
    expect(C100Sequence[80].url).toBe('/c100-rebuild/other-person-details/other-person-check');
    expect(C100Sequence[80].showInSection).toBe('c100');
    expect(C100Sequence[80].getNextStep({ oprs_otherPersonCheck: YesOrNo.YES })).toBe(
      '/c100-rebuild/other-person-details/add-other-persons'
    );
    expect(
      C100Sequence[80].getNextStep(
    ...
    expect(C100Sequence[81].url).toBe('/c100-rebuild/other-person-details/add-other-persons');
    expect(C100Sequence[81].showInSection).toBe('c100');
    expect(C100Sequence[81].getNextStep(otherPersonMockData.session.userCase, otherPersonMockData)).toBe(
      '/c100-rebuild/other-person-details/7228444b-ef3f-4202-a1e7-cdcd2316e1f6/personal-details'
    );

    expect(C100Sequence[82].url).toBe('/c100-rebuild/other-person-details/:otherPersonId/personal-details');
    expect(C100Sequence[82].showInSection).toBe('c100');
    expect(C100Sequence[82].getNextStep(otherPersonMockData.session.userCase, otherPersonMockData)).toBe(
    ...
    expect(C100Sequence[83].url).toBe('/c100-rebuild/other-person-details/:otherPersonId/address/lookup');
    expect(C100Sequence[83].showInSection).toBe('c100');
    expect(C100Sequence[83].getNextStep(otherPersonMockData.session.userCase, otherPersonMockData)).toBe(
      '/c100-rebuild/other-person-details/7228444b-ef3f-4202-a1e7-cdcd2316e1f6/address/select'
    );

    expect(C100Sequence[84].url).toBe('/c100-rebuild/other-person-details/:otherPersonId/address/select');
    expect(C100Sequence[84].showInSection).toBe('c100');
    expect(C100Sequence[84].getNextStep(otherPersonMockData.session.userCase, otherPersonMockData)).toBe(
      '/c100-rebuild/other-person-details/7228444b-ef3f-4202-a1e7-cdcd2316e1f6/address/manual'
    );

    expect(C100Sequence[85].url).toBe('/c100-rebuild/other-person-details/:otherPersonId/address/manual');
    ...
    expect(C100Sequence[86].url).toBe(
    ...
    expect(C100Sequence[87].url).toBe('/c100-rebuild/child-details/:childId/live-with/mainly-live-with');
    expect(C100Sequence[87].showInSection).toBe('c100');
    expect(C100Sequence[87].getNextStep(childrenMockData.session.userCase, childrenMockData)).toBe(
      '/c100-rebuild/child-details/7483640e-0817-4ddc-b709-6723f7925474/live-with/living-arrangements'
    );

    expect(C100Sequence[88].url).toBe('/c100-rebuild/child-details/:childId/live-with/living-arrangements');
    expect(C100Sequence[88].showInSection).toBe('c100');
    expect(C100Sequence[88].getNextStep(childrenMockData.session.userCase, childrenMockData)).toBe(
      '/c100-rebuild/other-proceedings/current-previous-proceedings'
    );

    expect(C100Sequence[89].url).toBe('/c100-rebuild/applicant/:applicantId/personal-details');
    expect(C100Sequence[89].showInSection).toBe('c100');
    expect(C100Sequence[89].getNextStep(applicantMockRequest.session.userCase, applicantMockRequest)).toBe(
      '/c100-rebuild/applicant/2732dd53-2e6c-46f9-88cd-08230e735b08/relationship-to-child/7483640e-0817-4ddc-b709-6723f7925474'
    );

    expect(C100Sequence[90].url).toBe('/c100-rebuild/applicant/:applicantId/relationship-to-child/:childId');
    expect(C100Sequence[90].showInSection).toBe('c100');
    expect(C100Sequence[90].getNextStep(applicantMockRequest.session.userCase, applicantMockRequest)).toBe(
      '/c100-rebuild/applicant/2732dd53-2e6c-46f9-88cd-08230e735b08/relationship-to-child/7483640e-0817-4ddc-b709-6723f7925635'
    );

    expect(C100Sequence[91].url).toBe('/c100-rebuild/applicant/:applicantId/contact-detail');
    expect(C100Sequence[91].showInSection).toBe('c100');
    expect(C100Sequence[91].getNextStep(applicantMockRequest.session.userCase, applicantMockRequest)).toBe(
      '/c100-rebuild/applicant/2732dd53-2e6c-46f9-88cd-08230e735b08/contact-preference'
    );

    expect(C100Sequence[92].url).toBe('/c100-rebuild/consent-order/upload');
    expect(C100Sequence[92].showInSection).toBe('c100');
    expect(C100Sequence[92].getNextStep({})).toBe('/c100-rebuild/consent-order/upload-confirmation');

    expect(C100Sequence[93].url).toBe('/c100-rebuild/consent-order/upload-confirmation');
    expect(C100Sequence[93].showInSection).toBe('c100');
    expect(C100Sequence[93].getNextStep({})).toBe('/c100-rebuild/hearing-urgency/urgent');

    expect(C100Sequence[94].url).toBe('/c100-rebuild/check-your-answers');
    expect(C100Sequence[94].showInSection).toBe('c100');
    expect(C100Sequence[94].getNextStep({})).toBe('/c100-rebuild/check-your-answers');
  });
});
