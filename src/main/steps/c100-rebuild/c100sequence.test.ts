...
describe('C100Sequence', () => {
  ...
  test('should contain 1 entries in c100 screen sequence', () => {
    expect(C100Sequence).toHaveLength(101);
    ...
    //
    // expect(C100Sequence[3].url).toBe('/c100-rebuild/confidentiality/start-alternative');
    ...
    // //
    // expect(C100Sequence[6].url).toBe('/c100-rebuild/international-elements/jurisdiction');
    // expect(C100Sequence[6].showInSection).toBe('c100');
    // expect(C100Sequence[6].getNextStep({})).toBe('/c100-rebuild/international-elements/request');
    //
    ...
    //
    // expect(C100Sequence[8].url).toBe('/c100-rebuild/international-elements/detailsknow');
