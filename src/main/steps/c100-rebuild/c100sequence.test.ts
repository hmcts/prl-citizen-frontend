...
describe('C100Sequence', () => {
  test('should contain 1 entries in c100 screen sequence', () => {
    ...
    expect(C100Sequence[8].getNextStep({})).toBe('/applicant/reasonable-adjustments/guidance');
    ...
    expect(C100Sequence[15].getNextStep({})).toBe('/c100-rebuild/case/create');
    ...
    expect(C100Sequence[31].url).toBe('/c100-rebuild/safety-concerns/concerns-for-safety');
    expect(C100Sequence[31].showInSection).toBe('c100');
    expect(C100Sequence[31].getNextStep({ c1A_haveSafetyConcerns: YesOrNo.YES })).toBe(
      '/c100-rebuild/safety-concerns/concern-about'
    );
    expect(C100Sequence[31].getNextStep({ c1A_haveSafetyConcerns: YesOrNo.NO })).toBe(
      '/c100-rebuild/international-elements/start'
    );

    expect(C100Sequence[32].url).toBe('/c100-rebuild/childaddress');
    expect(C100Sequence[32].showInSection).toBe('c100');
    expect(C100Sequence[32].getNextStep({})).toBe('/c100-rebuild/screening-questions/consent-agreement');

    expect(C100Sequence[33].url).toBe('/c100-rebuild/document-submission');
    expect(C100Sequence[33].showInSection).toBe('c100');
    expect(C100Sequence[33].getNextStep({})).toBe('/c100-rebuild/document-submission');

    expect(C100Sequence[35].url).toBe('/c100-rebuild/safety-concerns/concern-guidance');
    expect(C100Sequence[35].showInSection).toBe('c100');
    expect(C100Sequence[35].getNextStep({})).toBe('/c100-rebuild/safety-concerns/concerns-for-safety');

    expect(C100Sequence[36].url).toBe('/c100-rebuild/miam/mediator-document');
    expect(C100Sequence[36].showInSection).toBe('c100');
    expect(C100Sequence[36].getNextStep({ miam_haveDocSigned: YesOrNo.YES })).toBe('/c100-rebuild/miam/upload');
    expect(C100Sequence[36].getNextStep({ miam_haveDocSigned: YesOrNo.NO })).toBe('/c100-rebuild/miam/get-doc');

    /**
    Safety concerns navigation test cases
    */
    expect(C100Sequence[30].url).toBe('/c100-rebuild/safety-concerns/concern-about');
    expect(C100Sequence[30].showInSection).toBe('c100');
    expect(C100Sequence[30].getNextStep(safetyConcernsMockData.session.userCase)).toBe(
      '/c100-rebuild/safety-concerns/child/concerns-about'
    );

    expect(C100Sequence[34].url).toBe('/c100-rebuild/safety-concerns/child/concerns-about');
    expect(C100Sequence[34].showInSection).toBe('c100');
    expect(C100Sequence[34].getNextStep(safetyConcernsMockData.session.userCase)).toBe(
      '/c100-rebuild/safety-concerns/child/report-abuse/physicalAbuse'
    );

    safetyConcernsMockData.params = { abuseType: 'physicalAbuse' };
    expect(C100Sequence[38].url).toBe('/c100-rebuild/safety-concerns/child/report-abuse/:abuseType');
    expect(C100Sequence[38].showInSection).toBe('c100');
    expect(C100Sequence[38].getNextStep(safetyConcernsMockData.session.userCase, safetyConcernsMockData)).toBe(
    ...
    expect(C100Sequence[37].url).toBe('/c100-rebuild/safety-concerns/applicant/concerns-about');
    ...
    expect(C100Sequence[42].url).toBe('/c100-rebuild/safety-concerns/applicant/report-abuse/:abuseType');
    expect(C100Sequence[42].showInSection).toBe('c100');
    expect(C100Sequence[42].getNextStep(safetyConcernsMockData.session.userCase, safetyConcernsMockData)).toBe(
      '/c100-rebuild/safety-concerns/other-concerns/drugs'
    );
    /** End of safety concerns navigation test cases */

    expect(C100Sequence[39].url).toBe('/c100-rebuild/miam/other-proceedings');
    expect(C100Sequence[39].showInSection).toBe('c100');
    expect(C100Sequence[39].getNextStep({ miam_otherProceedings: YesOrNo.YES })).toBe('/c100-rebuild/miam/no-need');
    expect(C100Sequence[39].getNextStep({ miam_otherProceedings: YesOrNo.NO })).toBe('/c100-rebuild/miam/miam-info');
    ...
    expect(C100Sequence[41].getNextStep({ miam_mediatorDocument: YesOrNo.YES })).toBe(
      '/c100-rebuild/miam/mediator-document'
    );
    expect(C100Sequence[41].getNextStep({ miam_mediatorDocument: YesOrNo.NO })).toBe('/c100-rebuild/miam/valid-reason');

    expect(C100Sequence[43].url).toBe('/c100-rebuild/miam/urgency');
    expect(C100Sequence[43].showInSection).toBe('c100');
    expect(C100Sequence[43].getNextStep(miamMockData.session.userCase)).toBe('/c100-rebuild/miam/previous-attendance');

    expect(C100Sequence[44].url).toBe('/c100-rebuild/miam/previous-attendance');
    expect(C100Sequence[44].showInSection).toBe('c100');
    expect(C100Sequence[44].getNextStep(miamMockData.session.userCase)).toBe('/c100-rebuild/miam/miam-other');

    expect(C100Sequence[45].url).toBe('/c100-rebuild/miam/miam-info');
    expect(C100Sequence[45].showInSection).toBe('c100');
    expect(C100Sequence[45].getNextStep({})).toBe('/c100-rebuild/miam/attendance');

    expect(C100Sequence[46].url).toBe('/c100-rebuild/miam/valid-reason');
    expect(C100Sequence[46].showInSection).toBe('c100');
    expect(C100Sequence[46].getNextStep({ miam_validReason: YesOrNo.YES })).toBe('/c100-rebuild/miam/general-reasons');
    expect(C100Sequence[46].getNextStep({ miam_validReason: YesOrNo.NO })).toBe('/c100-rebuild/miam/get-mediator');

    expect(C100Sequence[47].url).toBe('/c100-rebuild/miam/no-need');
    expect(C100Sequence[47].showInSection).toBe('c100');
    expect(C100Sequence[47].getNextStep({})).toBe('/c100-rebuild/other-proceedings/current-previous-proceedings');

    expect(C100Sequence[48].url).toBe('/c100-rebuild/miam/miam-other');
    ...
    expect(C100Sequence[49].url).toBe('/c100-rebuild/miam/child-protection');
    expect(C100Sequence[49].showInSection).toBe('c100');
    expect(C100Sequence[49].getNextStep(miamMockData.session.userCase)).toBe('/c100-rebuild/miam/urgency');

    expect(C100Sequence[50].url).toBe('/c100-rebuild/miam/domestic-abuse');
    expect(C100Sequence[50].showInSection).toBe('c100');
    expect(C100Sequence[50].getNextStep(miamMockData.session.userCase)).toBe('/c100-rebuild/miam/child-protection');

    expect(C100Sequence[51].url).toBe('/c100-rebuild/miam/general-reasons');
    expect(C100Sequence[51].showInSection).toBe('c100');
    expect(C100Sequence[51].getNextStep(miamMockData.session.userCase)).toBe('/c100-rebuild/miam/domestic-abuse');

    expect(C100Sequence[52].url).toBe('/c100-rebuild/miam/get-mediator');
    expect(C100Sequence[52].showInSection).toBe('c100');
    expect(C100Sequence[52].getNextStep({})).toBe('/c100-rebuild/miam/get-mediator');

    expect(C100Sequence[53].url).toBe('/c100-rebuild/miam/upload');
    expect(C100Sequence[53].showInSection).toBe('c100');
    expect(C100Sequence[53].getNextStep({})).toBe('/c100-rebuild/miam/upload-confirmation');

    expect(C100Sequence[54].url).toBe('/c100-rebuild/miam/upload-confirmation');
    expect(C100Sequence[54].showInSection).toBe('c100');
    expect(C100Sequence[54].getNextStep({})).toBe('/c100-rebuild/typeoforder/select-courtorder');

    expect(C100Sequence[55].url).toBe('/c100-rebuild/miam/get-doc');
    expect(C100Sequence[55].showInSection).toBe('c100');
    expect(C100Sequence[55].getNextStep({})).toBe('/c100-rebuild/miam/get-doc');

    expect(C100Sequence[56].url).toBe('/c100-rebuild/miam/no-need-with-reasons');
    expect(C100Sequence[56].showInSection).toBe('c100');
    expect(C100Sequence[56].getNextStep(miamMockData.session.userCase)).toBe(
      '/c100-rebuild/typeoforder/select-courtorder'
    );
    expect(C100Sequence[57].url).toBe('/c100-rebuild/hearing-urgency/urgent');
    expect(C100Sequence[57].getNextStep({ hu_urgentHearingReasons: YesOrNo.YES })).toBe(
      '/c100-rebuild/hearing-urgency/urgent-details'
    );
    expect(C100Sequence[57].getNextStep({ hu_urgentHearingReasons: YesOrNo.NO })).toBe(
      '/c100-rebuild/hearing-without-notice/hearing-part1'
    );

    expect(C100Sequence[58].url).toBe('/c100-rebuild/hearing-urgency/urgent-details');
    expect(C100Sequence[58].showInSection).toBe('c100');
    expect(C100Sequence[58].getNextStep({})).toBe('/c100-rebuild/hearing-without-notice/hearing-part1');

    expect(C100Sequence[59].url).toBe('/c100-rebuild/safety-concerns/other-concerns/drugs');
    expect(C100Sequence[59].showInSection).toBe('c100');
    expect(C100Sequence[59].getNextStep({})).toBe('/c100-rebuild/safety-concerns/other-concerns/other-issues');

    expect(C100Sequence[60].url).toBe('/c100-rebuild/safety-concerns/abduction/passport-amount');
    expect(C100Sequence[60].showInSection).toBe('c100');
    expect(C100Sequence[60].getNextStep({})).toBe('/c100-rebuild/safety-concerns/abduction/passport-office-notified');

    expect(C100Sequence[61].url).toBe('/c100-rebuild/safety-concerns/abduction/passport-office-notified');
    expect(C100Sequence[61].showInSection).toBe('c100');
    expect(C100Sequence[61].getNextStep({})).toBe('/c100-rebuild/safety-concerns/abduction/threats');

    expect(C100Sequence[62].url).toBe('/c100-rebuild/safety-concerns/other-concerns/other-issues');
    expect(C100Sequence[62].showInSection).toBe('c100');
    expect(C100Sequence[62].getNextStep({})).toBe('/c100-rebuild/safety-concerns/orders-required/court-action');

    expect(C100Sequence[63].url).toBe('/c100-rebuild/safety-concerns/abduction/previousabductions');
    expect(C100Sequence[63].showInSection).toBe('c100');
    expect(C100Sequence[63].getNextStep(safetyConcernsMockData.session.userCase, safetyConcernsMockData)).toBe(
      '/c100-rebuild/safety-concerns/applicant/concerns-about'
    );

    expect(C100Sequence[64].url).toBe('/c100-rebuild/safety-concerns/orders-required/court-action');
    expect(C100Sequence[64].showInSection).toBe('c100');
    expect(C100Sequence[64].getNextStep({})).toBe('/c100-rebuild/safety-concerns/orders-required/unsupervised');

    expect(C100Sequence[65].url).toBe('/c100-rebuild/safety-concerns/abduction/child-location');
    expect(C100Sequence[65].showInSection).toBe('c100');
    expect(C100Sequence[65].getNextStep({})).toBe('/c100-rebuild/safety-concerns/abduction/passport-office');

    expect(C100Sequence[66].url).toBe('/c100-rebuild/safety-concerns/abduction/passport-office');
    expect(C100Sequence[66].showInSection).toBe('c100');
    expect(C100Sequence[66].getNextStep({ c1A_passportOffice: YesOrNo.YES })).toBe(
      '/c100-rebuild/safety-concerns/abduction/passport-amount'
    );
    expect(C100Sequence[66].getNextStep({ c1A_passportOffice: YesOrNo.NO })).toBe(
      '/c100-rebuild/safety-concerns/abduction/threats'
    );

    expect(C100Sequence[67].url).toBe('/c100-rebuild/screening-questions/consent-agreement');
    expect(C100Sequence[67].showInSection).toBe('c100');
    expect(C100Sequence[67].getNextStep({ sq_writtenAgreement: YesOrNo.YES })).toBe(
      '/c100-rebuild/typeoforder/select-courtorder'
    );
    expect(C100Sequence[67].getNextStep({ sq_writtenAgreement: YesOrNo.NO })).toBe(
      '/c100-rebuild/screening-questions/alternative-resolution'
    );

    expect(C100Sequence[68].url).toBe('/c100-rebuild/screening-questions/alternative-resolution');
    expect(C100Sequence[68].showInSection).toBe('c100');
    expect(C100Sequence[68].getNextStep({})).toBe('/c100-rebuild/screening-questions/alternative-routes');

    expect(C100Sequence[69].url).toBe('/c100-rebuild/screening-questions/legal-representation');
    expect(C100Sequence[69].showInSection).toBe('c100');
    expect(C100Sequence[69].getNextStep({ sq_legalRepresentation: YesOrNo.YES })).toBe(
      '/c100-rebuild/screening-questions/legal-representation-application'
    );
    expect(C100Sequence[69].getNextStep({ sq_legalRepresentation: YesOrNo.NO })).toBe(
      '/c100-rebuild/screening-questions/permission'
    );

    expect(C100Sequence[70].url).toBe('/c100-rebuild/screening-questions/legal-representation-application');
    expect(C100Sequence[70].showInSection).toBe('c100');
    expect(C100Sequence[70].getNextStep({ sq_legalRepresentationApplication: YesOrNo.YES })).toBe(
      '/c100-rebuild/screening-questions/contact-representative'
    );
    expect(C100Sequence[70].getNextStep({ sq_legalRepresentationApplication: YesOrNo.NO })).toBe(
      '/c100-rebuild/screening-questions/permission'
    );

    expect(C100Sequence[71].url).toBe('/c100-rebuild/screening-questions/permissions-request');
    expect(C100Sequence[71].showInSection).toBe('c100');
    expect(C100Sequence[71].getNextStep({})).toBe('/c100-rebuild/miam/other-proceedings');

    expect(C100Sequence[72].url).toBe('/c100-rebuild/screening-questions/alternative-routes');
    expect(C100Sequence[72].showInSection).toBe('c100');
    expect(C100Sequence[72].getNextStep({})).toBe('/c100-rebuild/screening-questions/legal-representation');

    expect(C100Sequence[73].url).toBe('/c100-rebuild/screening-questions/permissions-why');
    expect(C100Sequence[73].showInSection).toBe('c100');
    expect(C100Sequence[73].getNextStep({})).toBe('/c100-rebuild/screening-questions/permissions-request');

    expect(C100Sequence[74].url).toBe('/c100-rebuild/safety-concerns/abduction/threats');
    expect(C100Sequence[74].showInSection).toBe('c100');
    expect(C100Sequence[74].getNextStep({ c1A_childAbductedBefore: YesOrNo.YES })).toBe(
      '/c100-rebuild/safety-concerns/abduction/previousabductions'
    );
    expect(C100Sequence[74].getNextStep(safetyConcernsMockData.session.userCase, safetyConcernsMockData)).toBe(
      '/c100-rebuild/safety-concerns/applicant/concerns-about'
    );

    expect(C100Sequence[75].url).toBe('/c100-rebuild/safety-concerns/no-feedback');
    expect(C100Sequence[75].showInSection).toBe('c100');
    expect(C100Sequence[75].getNextStep({})).toBe('/c100-rebuild/safety-concerns/child/concerns-about');

    expect(C100Sequence[76].url).toBe('/c100-rebuild/screening-questions/permission');
    expect(C100Sequence[76].showInSection).toBe('c100');
    expect(C100Sequence[76].getNextStep({ sq_courtPermissionRequired: YesOrNo.YES })).toBe(
      '/c100-rebuild/screening-questions/permissions-why'
    );
    expect(C100Sequence[76].getNextStep({ sq_courtPermissionRequired: YesOrNo.NO })).toBe(
      '/c100-rebuild/miam/other-proceedings'
    );

    expect(C100Sequence[77].url).toBe('/c100-rebuild/screening-questions/contact-representative');
    expect(C100Sequence[77].showInSection).toBe('c100');
    expect(C100Sequence[77].getNextStep({})).toBe('/c100-rebuild/screening-questions/contact-representative');

    expect(C100Sequence[78].url).toBe('/c100-rebuild/safety-concerns/orders-required/unsupervised');
    expect(C100Sequence[78].showInSection).toBe('c100');
    expect(C100Sequence[78].getNextStep({})).toBe('/c100-rebuild/international-elements/start');
    ...
    expect(C100Sequence[88].url).toBe('/c100-rebuild/child-details/has-other-children');
    expect(C100Sequence[88].showInSection).toBe('c100');
    expect(C100Sequence[88].getNextStep({ ocd_hasOtherChildren: YesOrNo.NO })).toBe(
      '/c100-rebuild/applicant/add-applicants'
    );
    expect(C100Sequence[88].getNextStep({ ocd_hasOtherChildren: YesOrNo.YES })).toBe(
      '/c100-rebuild/child-details/other-children/names'
    );

    expect(C100Sequence[89].url).toBe('/c100-rebuild/child-details/other-children/names');
    expect(C100Sequence[89].showInSection).toBe('c100');
    expect(C100Sequence[89].getNextStep(otherChildrenMockData.session.userCase, otherChildrenMockData)).toBe(
      '/c100-rebuild/child-details/other-children/c9f56483-6e2d-43ce-9de8-72661755b87c/personal-details'
    );

    expect(C100Sequence[90].url).toBe('/c100-rebuild/child-details/other-children/:childId/personal-details');
    expect(C100Sequence[90].showInSection).toBe('c100');
    expect(C100Sequence[90].getNextStep(otherChildrenMockData.session.userCase, otherChildrenMockData)).toBe(
      '/c100-rebuild/applicant/add-applicants'
    );

    expect(C100Sequence[91].url).toBe('/c100-rebuild/respondent-details/add-respondents');
    expect(C100Sequence[91].showInSection).toBe('c100');
    expect(C100Sequence[91].getNextStep(respondentMockData.session.userCase)).toBe(
      '/c100-rebuild/respondent-details/2732dd53-2e6c-46f9-88cd-08230e735b08/personal-details'
    );

    expect(C100Sequence[92].url).toBe('/c100-rebuild/respondent-details/:respondentId/personal-details');
    expect(C100Sequence[92].showInSection).toBe('c100');
    expect(C100Sequence[92].getNextStep(respondentMockData.session.userCase, respondentMockData)).toBe(
    ...
    expect(C100Sequence[93].url).toBe('/c100-rebuild/respondent-details/:respondentId/relationship-to-child/:childId');
    expect(C100Sequence[93].showInSection).toBe('c100');
    expect(C100Sequence[93].getNextStep(respondentMockData.session.userCase, respondentMockData)).toBe(
      '/c100-rebuild/respondent-details/2732dd53-2e6c-46f9-88cd-08230e735b08/address/lookup'
    );

    expect(C100Sequence[94].url).toBe('/c100-rebuild/respondent-details/:respondentId/address/lookup');
    expect(C100Sequence[94].showInSection).toBe('c100');
    expect(C100Sequence[94].getNextStep(respondentMockData.session.userCase, respondentMockData)).toBe(
      '/c100-rebuild/respondent-details/2732dd53-2e6c-46f9-88cd-08230e735b08/address/select'
    );

    expect(C100Sequence[95].url).toBe('/c100-rebuild/respondent-details/:respondentId/address/select');
    expect(C100Sequence[95].showInSection).toBe('c100');
    ...
    expect(C100Sequence[96].url).toBe('/c100-rebuild/respondent-details/:respondentId/address/manual');
    expect(C100Sequence[96].showInSection).toBe('c100');
    ...
    expect(C100Sequence[101].url).toBe('/c100-rebuild/other-person-details/:otherPersonId/address/lookup');
    ...
    expect(C100Sequence[102].url).toBe('/c100-rebuild/other-person-details/:otherPersonId/address/select');
    ...
    expect(C100Sequence[103].url).toBe('/c100-rebuild/other-person-details/:otherPersonId/address/manual');
    ...
    expect(C100Sequence[105].url).toBe('/c100-rebuild/child-details/:childId/live-with');
    expect(C100Sequence[105].showInSection).toBe('c100');
    expect(C100Sequence[105].getNextStep(childrenMockData.session.userCase, childrenMockData)).toBe(
      '/c100-rebuild/other-proceedings/current-previous-proceedings'
    );

    expect(C100Sequence[106].url).toBe('/c100-rebuild/applicant/:applicantId/personal-details');
    expect(C100Sequence[106].showInSection).toBe('c100');
    expect(C100Sequence[106].getNextStep(applicantMockRequest.session.userCase, applicantMockRequest)).toBe(
      '/c100-rebuild/applicant/2732dd53-2e6c-46f9-88cd-08230e735b08/relationship-to-child/7483640e-0817-4ddc-b709-6723f7925474'
    );

    expect(C100Sequence[107].url).toBe('/c100-rebuild/applicant/:applicantId/relationship-to-child/:childId');
    expect(C100Sequence[107].showInSection).toBe('c100');
    expect(C100Sequence[107].getNextStep(applicantMockRequest.session.userCase, applicantMockRequest)).toBe(
      '/c100-rebuild/applicant/2732dd53-2e6c-46f9-88cd-08230e735b08/relationship-to-child/7483640e-0817-4ddc-b709-6723f7925635'
    );

    expect(C100Sequence[108].url).toBe('/c100-rebuild/applicant/:applicantId/contact-detail');
    expect(C100Sequence[108].showInSection).toBe('c100');
    expect(C100Sequence[108].getNextStep(applicantMockRequest.session.userCase, applicantMockRequest)).toBe(
      '/c100-rebuild/applicant/2732dd53-2e6c-46f9-88cd-08230e735b08/contact-preference'
    );

    expect(C100Sequence[109].url).toBe('/c100-rebuild/consent-order/upload');
    expect(C100Sequence[109].showInSection).toBe('c100');
    expect(C100Sequence[109].getNextStep({})).toBe('/c100-rebuild/consent-order/upload-confirmation');

    expect(C100Sequence[110].url).toBe('/c100-rebuild/consent-order/upload-confirmation');
    expect(C100Sequence[110].showInSection).toBe('c100');
    expect(C100Sequence[110].getNextStep({})).toBe('/c100-rebuild/hearing-urgency/urgent');

    expect(C100Sequence[111].url).toBe('/c100-rebuild/check-your-answers');
