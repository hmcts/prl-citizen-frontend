...
describe('C100Sequence', () => {
  test('should contain 1 entries in c100 screen sequence', () => {
    ...
    expect(C100Sequence[71].url).toBe('/c100-rebuild/consent-order/upload');
    expect(C100Sequence[71].showInSection).toBe('c100');
    expect(C100Sequence[71].getNextStep({})).toBe('/c100-rebuild/consent-order/upload-confirmation');

    expect(C100Sequence[72].url).toBe('/c100-rebuild/consent-order/upload-confirmation');
    expect(C100Sequence[72].showInSection).toBe('c100');
    expect(C100Sequence[72].getNextStep({})).toBe('/c100-rebuild/consent-order/upload-confirmation');
  });
});
