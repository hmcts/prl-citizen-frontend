...
describe('C100Sequence', () => {
  test('should contain 1 entries in c100 screen sequence', () => {
    ...
    expect(C100Sequence[73].url).toBe('/c100-rebuild/safety-concerns/orders-required');
    expect(C100Sequence[73].showInSection).toBe('c100');
    expect(C100Sequence[73].getNextStep({})).toBe('/c100-rebuild/safety-concerns/orders-required');
    ...
    expect(C100Sequence[74].getNextStep({})).toBe('/c100-rebuild/safety-concerns/abduction/child-location');
    ...
    expect(C100Sequence[76].url).toBe('/c100-rebuild/consent-order/upload');
    expect(C100Sequence[76].showInSection).toBe('c100');
    expect(C100Sequence[76].getNextStep({})).toBe('/c100-rebuild/consent-order/upload-confirmation');

    expect(C100Sequence[77].url).toBe('/c100-rebuild/consent-order/upload-confirmation');
    expect(C100Sequence[77].showInSection).toBe('c100');
    expect(C100Sequence[77].getNextStep({})).toBe('/c100-rebuild/consent-order/upload-confirmation');
  });
});
