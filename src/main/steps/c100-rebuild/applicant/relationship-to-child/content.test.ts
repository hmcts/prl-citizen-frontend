...
const en = {
  pageTitle: 'What is their relationship to the child',
  title: 'What is ',
...
describe('applicant relationshipDetails details', () => {
  ...
  test('should contain relationshipDetails details form fields', () => {
    ...
    expect((relationshipType.label as LanguageLookup)(generatedContent)).toBe(
      `${en.title} Amy Root${en.title1} Bob Silly`
    );
