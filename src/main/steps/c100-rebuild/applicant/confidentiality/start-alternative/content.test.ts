...
describe('applicant personal details > applying-with > content', () => {
  ...
  test('should contain applyingWith field', () => {
    ...
    subFields.validator!('', { startAlternative: 'Yes' }) as unknown as Validator;
  ...
  test('rendering form fields - toggled check as yes', () => {
    ...
    expect(generatedContentFields.form.fields._ctx.value).toBe('appl_start_alternative');
    expect(generatedContentFields['form'].fields['startAlternative'].values[0].attributes.checked).toBe(true);
  });
  ...
  test('rendering form fields - toggled check as no', () => {
    ...
    expect(generatedContentFields.caption).toBe('Keeping your contact details private');
    expect(generatedContentFields.form.fields._ctx.value).toBe('appl_start_alternative');
    expect(generatedContentFields['form'].fields['startAlternative'].values[1].attributes.checked).toBe(true);
  });
