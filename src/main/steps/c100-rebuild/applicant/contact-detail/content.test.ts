...
const en = {
  ...
  canNotProvideTelephoneNumberReasonLabel: 'Tell us why the court cannot phone you',
  errors: {
    canProvideEmail: {
    ...
    canNotProvideEmailReason: {
      required: 'Please tell us why you can not provide email address',
    },
    canLeaveVoiceMail: {
...
const cy = {
  ...
  canNotProvideTelephoneNumberReason: 'Tell us why the court cannot phone you - welsh',
  errors: {
    canProvideEmail: {
