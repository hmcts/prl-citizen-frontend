...
const en = {
  ...
  title: 'About the financial abuse',
  ...
  errors: {
    'respondentSafetyConcerns.financialAbuseDescription.explainWhoWasInvolved': {
      required: 'Please describe what happened and who was involved? ',
    },
    'respondentSafetyConcerns.financialAbuseDescription.whenDidBehaviourStart': {
      required: 'Please explain when did this behaviour start? ',
    },
    'respondentSafetyConcerns.financialAbuseDescription.isBehaviourStillGoingOn': {
      required: 'Please explain is nehaviour still going on? ',
    },
    'respondentSafetyConcerns.financialAbuseDescription.haveYouEverAskedForHelp': {
