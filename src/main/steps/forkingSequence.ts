...
export const forkingSequence: Step[] = [
  {
    url: SCREENING_QUESTION_GUIDANCE,
    showInSection: Sections.Forking,
  ...
  },
  {
    ...
    showInSection: Sections.Forking,
    getNextStep: (caseData: Partial<CaseWithId>) =>
      caseData.applicationPayOnline === YesOrNo.YES ? SCREENING_QUESTION_GUIDANCE : SCREENING_QUESTION_PAPER_FORM,
  },
];
