...
const cy = {
  ...
  paragraphs: [
    'Mae’r gwasanaeth hwn yn caniatáu i ddarpar rieni wneud cais i fabwysiadu plentyn ar-lein.',
  ...
  notAccessibleParts: [
    'nid yw’r testun yn newid i fod mewn un golofn pan fyddwch yn newid maint ffenestr y porwr',
    'ni allwch newid lled y llinellau neu fylchiad y testun',
    'Nid yw’r holl ddolenni yn y troedynnau yn weithredol ac felly nid ydynt wedi’u profi.',
  ],
  ...
  nonAccessibleDescription: 'Dogfennau',
  ...
  thirdPartyContent1: 'Problemau gyda dolenni',
  thirdPartyContent2: 'Problemau gyda dolenni',
  thirdPartyContent3: 'Problemau gyda dolenni',
  thirdPartyContentDescriptions: ['Problemau gyda dolenni', 'Problemau gyda dolenni'],
  toImproveAccessibility: 'Problemau gyda phenawdau',
  improveAccessibilityDescription: [
  ...
  preparationAccessibilityStatement: 'Adnodd dadansoddi cyferbyniad lliwiau i ddilysu cymarebau cyferbyniad',
  statementPreparationInfo: [
