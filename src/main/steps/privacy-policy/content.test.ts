...
const cy: typeof en = {
  ...
  yourName: 'your name, address and contact details {in welsh}',
  ...
  govCookies: 'We use cookies to collect data that tells us about how you’re using this service, including: {in welsh}',
