...
const en = {
  ...
  process:
    "enable us to process your client's application",
  legal:
  ...
  clientsData:
    "your client’s personal data - including their name, address and contact details",
  collectMore:
    'We collect more personal data for some types of application.',
  ...
  emailUs:
    "email us: <a class='govuk-link' href='mailto:data.access@justice.gov.uk'>data.access@justice.gov.uk</a>",
  moreInformation:
  ...
  emailDPO:
    "emailing: <a class='govuk-link' href='mailto:DPO@justice.gov.uk'>DPO@justice.gov.uk</a>",
  ...
  ico:
    "You can also complain to the  <a class='govuk-link' href='mailto:privacy@justice.gov.uk'>Information Commissioner’s Office</a> if you’re not satisfied with our response or believe we are not processing your personal data lawfully.",
};
...
const cy: typeof en = {
  ...
  personalData:
    'More information about using this service is in the terms and conditions. {in welsh}',
  thePersonal: 'Why we collect your personal data {in welsh}',
  whenYouUseService: 
    'We collect personal data to: {in welsh}',
  process:
    "enable us to process your client's application {in welsh}",
  legal:
    'meet legal requirements {in welsh}',
  improvements:
    'make improvements to this service',
  staffAndPersonalData:
  ...
  personalDataCollected:
    'The personal data we collect includes: {in welsh}',
  name:
    'your name, address and contact details {in welsh}',
  email:
    'your email and password (if you create an account) {in welsh}',
  personalInformation:
    'other personal information you provide in your claim or application {in welsh}',
  clientsData:
    "your client’s personal data - including their name, address and contact details {in welsh}",
  collectMore:
    'We collect more personal data for some types of application. {in welsh}',
  ...
  cookies:
    'We use cookies to collect data that tells us about how you’re using this service, including: {in welsh}',
  openEmail:
    'if you open an email from us or click on a link in an email {in welsh}',
  ipAddress:
    'your computer, phone or tablet’s IP address {in welsh}',
  region:
    'the region or town where you are using your computer, phone or tablet {in welsh}',
  webBrowser:
    'the web browser you use {in welsh}',
  ...
  youCanAsk:
    'You can ask: {in welsh}',
  seeData:
    'to see the personal data that we hold on you {in welsh}',
  changeData:
    'to have the personal data corrected {in welsh}',
  deleteData:
  ...
  seePersonalData:
    'If you want to see the personal data that we hold on you, you can: {in welsh}',
  mojForm:
  ...
  writeToUs:
    'write to us: Disclosure Team, Post point 10.24, 102 Petty France, London, SW1H 9AJ {in welsh}',
  emailUs:
    "email us: <a class='govuk-link' href='mailto:data.access@justice.gov.uk'>data.access@justice.gov.uk</a> {in welsh}",
  moreInformation:
    'You can ask for more information about: {in welsh}',
  sharingInformation:
    'agreements we have on sharing information with other organisations {in welsh}',
  passingOnInfo:
    'when we are allowed to pass on personal information without telling you {in welsh}',
  staffInstructions:
    'our instructions to staff on how to collect, use or delete your personal information {in welsh}',
  checkingInfo:
    'how we check that the information we hold is accurate and up-to-date {in welsh}',
  contactingMOJDataProtection:
    'You can contact the MoJ data protection officer by: {in welsh}',
  write:
  ...
  emailDPO:
    "emailing: <a class='govuk-link' href='mailto:DPO@justice.gov.uk'>DPO@justice.gov.uk</a> {in welsh}",
  ...
  complaintsWritten:
    'Write to: Post point 10.38, 102 Petty France, London, SW1H 9AJ {in welsh}',
  complaintsEmail:
    "Email:  <a class='govuk-link' href='https://ico.org.uk/global/contact-us'>privacy@justice.gov.uk</a> {in welsh}",
  ico:
    "You can also complain to the  <a class='govuk-link' href='mailto:privacy@justice.gov.uk'>Information Commissioner’s Office</a> if you’re not satisfied with our response or believe we are not processing your personal data lawfully. {in welsh}",
};
