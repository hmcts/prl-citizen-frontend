...
describe('applicant1Sequence', () => {
  test('should contain 1 entries in applicant 1 screen sequence', () => {
    ...
    expect(applicantCaseSequence[60].url).toBe('/applicant/upload-document/document-sharing-details');
    expect(applicantCaseSequence[60].showInSection).toBe('aboutApplicantCase');
    expect(applicantCaseSequence[60].getNextStep({})).toBe('/applicant/upload-document/upload-your-documents');

    expect(applicantCaseSequence[61].url).toBe('/applicant/upload-document/upload-your-documents');
