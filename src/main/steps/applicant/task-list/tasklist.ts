...
import { getConfirmOrEditYourContactDetails, getKeepYourDetailsPrivateStatus, getWitnessStatementStatus} from './utils';
      ...
      items: [
        {
          ...
          status: getWitnessStatementStatus(userCase),
          href: URL.APPLICANT_DETAILS_KNOWN,
        },
