...
export const applicant_tasklist_items_all_docs_cy = {
  view_all_orders_from_the_court_all_docs: 'View all orders from the court - welsh',
  applicant_request_for_child_arrangements: "<nameapplicantxxxxx>'s request for child arrangements - welsh",
  applicant_request_for_domestic_abuse: "<nameapplicantxxxxx>'s request for domestic abuse - welsh",
  applicant_allegations_of_harm_and_violence: "<nameapplicantxxxxx>'s allegations of harm and violence - welsh",
  applicant_response_to_other_side_allegation_of_harm:
    "<nameapplicantxxxxx>'s response to the other side's allegations of harm or violence - welsh",
  applicant_position_statements: "<nameapplicantxxxxx>'s position statements - welsh",
  applicant_witness_statements: "<nameapplicantxxxxx>'s witness statements - welsh",
  other_people_witness_statements: "Other people's witness statements - welsh",
  medical_reports: 'Medical reports - welsh',
  miam_certificate: 'MIAM certificate - welsh',
  applications_made_in_these_proceedings: 'Applications made in these proceedings - welsh',
  previous_orders_submitted: 'Previous orders submitted with application - welsh',
  letters_from_school: 'Letters from school - welsh',
  digital_downloads: 'Emails, screenshots, images and other media files - welsh',
  medical_records: 'Medical records - welsh',
  paternity_test_reports: 'Paternity test reports - welsh',
  drug_alcohol_tests: 'Drug and alcohol tests (toxicology) - welsh',
  police_disclosures: 'Police reports - welsh',
  witness_availability: 'Witness availability - welsh',
  tenancy_and_mortgage_availability: 'Tenancy and mortgage agreements - welsh',
  respondent_response_to_request_for_child_arrangements:
    "<namerespondentxxxxx>'s response to the request for child arrangements - welsh",
  ...
  // respondent_allegation_of_harm_and_violence: "<namerespondentxxxxx>'s allegations of harm and violence",
  applications_made_in_these_proceedings_respondent: 'Applications made in these proceedings - welsh',
  previous_orders_submitted_respondent: 'Previous orders submitted with application - welsh',
  letters_from_school_respondent: 'Letters from school - welsh',
  respondent_position_statements: "<namerespondentxxxxx>'s position statements - welsh",
  respondent_witness_statements: "<namerespondentxxxxx>'s witness statements - welsh",
  other_people_witness_statements_respondent: "Other people's witness statements - welsh",
  digital_downloads_respondent: 'Emails, screenshots, images and other media files - welsh',
  medical_records_respondent: 'Medical records - welsh',
  medical_reports_respondent: 'Medical reports - welsh',
  paternity_test_reports_respondent: 'Paternity test reports - welsh',
  drug_alcohol_tests_respondent: 'Drug and alcohol tests (toxicology) - welsh',
  police_disclosures_respondent: 'Police reports - welsh',
  witness_availability_respondent: 'Witness availability - welsh',
  safeguarding_letter: 'Safeguarding letter - welsh',
  section7_report: 'Section 7 report - welsh',
  section37_report: 'Section 37 report - welsh',
  risk_assessment_16a: '16a risk assessment - welsh',
  important_address_and_contact_details: 'Important information about your address and contact details - welsh',
  dna_reports: 'DNA reports - welsh',
  privacy_notice: 'Privacy notice - welsh',
  special_measures: 'Special measures - welsh',
  notice_of_hearing: 'Notice of hearing - welsh',
  support_you_need_during_your_case: 'Support you need during your case - welsh',
  other_documents: 'Other documents - welsh',
};
