...
import ApplicantKeepDetailsPrivatePostController from './postController';
...
describe('ApplicantRemoveLegalRepresentativePostController', () => {
  let controller = new ApplicantKeepDetailsPrivatePostController({});
  ...
  test('post should redirect to same page when declaration check not present', async () => {
    ...
    controller = new ApplicantKeepDetailsPrivatePostController(form.fields as FormFields);
