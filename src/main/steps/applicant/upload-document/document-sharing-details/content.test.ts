...
describe('applicant -> upload-document -> document-sharing-details', () => {
  ...
  test('should return correct english content', () => {
    ...
    expect(generatedContent.bodyContent).toEqual('If your contact details have changed, go to <a href=\"/applicant/confirm-contact-details/checkanswers\" class=\"govuk-link\" target=\"_self\">confirm or edit your contact details</a> to update them.');
  });
  ...
  test('should return correct welsh content', () => {
    ...
    expect(generatedContent.bodyContent).toEqual('If your contact details have changed, go to <a href=\"/applicant/confirm-contact-details/checkanswers\" class=\"govuk-link\" target=\"_self\">confirm or edit your contact details</a> to update them. - welsh');
  });
