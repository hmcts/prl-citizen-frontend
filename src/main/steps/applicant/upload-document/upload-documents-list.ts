  ...
  return [
    {
      ...
      items: [
        ...
        },
        {
          ...
          href: applyParms(url, {docCategory: DocCategory.WITNESS_STATEMENT, docType: DocType.YOUR_WITNESS_STATEMENTS}),
        },
        {
          id: 'other-witness-statements',
          text: taskListItems.other_witness_statements,
          href: applyParms(url, {docCategory: DocCategory.WITNESS_STATEMENT, docType: DocType.OTHER_PEOPLE_WITNESS_STATEMENTS}),
        },
        {
        ...
        },
        {
          ...
          href: applyParms(url, {docCategory: DocCategory.WITNESS_STATEMENT, docType: DocType.TENANCY_AND_MORTGAGE_AVAILABILITY}),
        },
      ],
    },
    {
