...
import { DETAILS_KNOWN, RESPONDENT_TASK_LIST_URL, START_ALTERNATIVE, MIAM_START, MIAM_ATTEND_WILLINGNESS, PRIVATE_DETAILS_CONFIRMED, PRIVATE_DETAILS_NOT_CONFIRMED, MIAM_SUMMARY, CHECK_ANSWERS, SAFETY_MAIN_PAGE, YOUR_SAFETY, DOMESTIC_ABUSE_RISK, DOMESTIC_ABUSE_RISK_NO } from '../urls';
import { YesOrNo } from '../../app/case/definition';
import { Sections, Step } from '../constants';
import {
  DETAILS_KNOWN,
