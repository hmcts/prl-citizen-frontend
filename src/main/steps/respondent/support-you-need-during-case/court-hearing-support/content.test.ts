...
describe('citizen-home content', () => {
  ...
  test('should contain courthearing field', () => {
    ...
    expect((courthearingField.values[0].subFields?.supportWorkerDetails.validator as Function)(generatedContent)).toBe(
      undefined
    );
    ...
    expect((courthearingField.values[1].subFields?.familyProviderDetails.validator as Function)(generatedContent)).toBe(
      undefined
    );
    ...
    expect((courthearingField.values[3].subFields?.therapyDetails.validator as Function)(generatedContent)).toBe(
      undefined
    );
    ...
    expect(
      (courthearingField.values[4].subFields?.communicationSupportOther.validator as Function)(generatedContent)
    ).toBe(undefined);
