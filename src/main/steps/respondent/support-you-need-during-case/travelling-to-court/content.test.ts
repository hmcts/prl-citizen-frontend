...
describe('citizen-home content', () => {
  ...
  test('should contain courthearing field', () => {
    ...
    expect((travellingtoCourtField.values[0].subFields?.parkingDetails.label as Function)(generatedContent)).toBe(en.parkingSpaceDetails);
    expect((travellingtoCourtField.values[0].subFields?.parkingDetails.validator as Function)(generatedContent)).toBe(undefined);
    ...
    expect((travellingtoCourtField.values[5].subFields?.differentChairDetails.label as Function)(generatedContent)).toBe(en.differentChairDetails);
    expect((travellingtoCourtField.values[5].subFields?.differentChairDetails.hint as Function)(generatedContent)).toBe(en.differentChairDetailsHint);
    expect((travellingtoCourtField.values[5].subFields?.differentChairDetails.validator as Function)(generatedContent)).toBe(undefined);
    ...
    expect((travellingtoCourtField.values[7].subFields?.travellingOtherDetails.label as Function)(generatedContent)).toBe(en.otherDetails);
    expect((travellingtoCourtField.values[7].subFields?.travellingOtherDetails.validator as Function)(generatedContent)).toBe(undefined);
