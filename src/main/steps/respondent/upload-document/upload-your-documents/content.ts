...
const cy: typeof en = {
  ...
  uplodFileText2: 'Files must end with JPG, BMP, PNG,TIF, PDF, DOC or DOCX. (welsh)',
  uplodFileText3: 'How to take a picture of a document on your phone and upload it (welsh)',
  uplodFileText4: 'Place your document on a flat service in a well-lit room. Use a flash if you need to. (welsh)',
  uplodFileText5: 'Take a picture of the whole document. You should be able to see its edges. (welsh)',
  uplodFileText6: 'Check you can read all the writing, including the handwriting. (welsh)',
  uplodFileText7: 'Email or send the photo or scan to the device you are using now. (welsh)',
  uplodFileText8: 'Upload it here. (welsh)',
  uploadFileHeading: 'Upload a file (welsh)',
  uploadFile: 'Upload file (welsh)',
