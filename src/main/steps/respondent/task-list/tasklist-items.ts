...
export const respondent_tasklist_items_cy = {
  ...
  check_details_of_your_court_hearings: 'Gwirio manylion eich gwrandawiadau llys',
  upload_document: 'Llwytho dogfennau',
  view_all_orders_from_the_court: 'Gweld pob gorchymyn gan y llys',
  view_all_documents: 'Gweld pob dogfen',
