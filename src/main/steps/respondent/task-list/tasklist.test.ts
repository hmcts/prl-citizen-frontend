...
describe('generateRespondentTaskList', () => {
  ...
  test('generateRespondentTaskListForC100 with aohviolence and cadafinaldocument ready to view', () => {
    const data = {
      userCase: {
        ...mockUserCase,
  ...
  test('generateRespondentTaskListForDACase with cadafinaldocument ready to view', () => {
    const data = {
      userCase: {
        ...mockUserCase,
        legalRepresentation: YesOrNo.NO,
