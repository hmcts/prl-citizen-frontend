...
describe('respondent1Sequence', () => {
  test('should contain 1 entries in respondent 1 screen sequence', () => {
    ...
    expect(respondentCaseSequence[8].getNextStep({})).toBe('/respondent/miam/miam-non-attendance-reason');

    expect(respondentCaseSequence[9].url).toBe('/respondent/miam/miam-non-attendance-reason');
    expect(respondentCaseSequence[9].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[9].getNextStep({})).toBe('/respondent/miam/summary');

    expect(respondentCaseSequence[10].url).toBe('/respondent/miam/summary');
    ...
    expect(respondentCaseSequence[11].url).toBe('/respondent/confirm-contact-details/checkanswers');
    ...
    expect(respondentCaseSequence[12].url).toBe('/respondent/confirm-contact-details/personaldetails');
    ...
    expect(respondentCaseSequence[13].url).toBe('/respondent/confirm-contact-details/contactdetails');
    ...
    expect(respondentCaseSequence[14].url).toBe('/respondent/confirm-contact-details/addressdetails');
    expect(respondentCaseSequence[14].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[14].getNextStep({})).toBe('/respondent/confirm-contact-details/addresslookup');

    expect(respondentCaseSequence[15].url).toBe('/respondent/confirm-contact-details/addresslookup');
    expect(respondentCaseSequence[15].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[15].getNextStep({})).toBe('/respondent/confirm-contact-details/addresslookupcont');

    expect(respondentCaseSequence[16].url).toBe('/respondent/confirm-contact-details/addresslookupcont');
    ...
    expect(respondentCaseSequence[17].url).toBe('/respondent/confirm-contact-details/addresslookup');
    expect(respondentCaseSequence[17].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[17].getNextStep({})).toBe('/respondent/confirm-contact-details/addressconfirmation');

    expect(respondentCaseSequence[18].url).toBe('/respondent/confirm-contact-details/addressconfirmation');
    ...
    expect(respondentCaseSequence[19].url).toBe('/respondent/confirm-contact-details/addressblank');
    ...
    expect(respondentCaseSequence[20].url).toBe('/respondent/confirm-contact-details/addresshistory');
    expect(respondentCaseSequence[20].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[20].getNextStep({})).toBe('/respondent/task-list');

    expect(respondentCaseSequence[21].url).toBe('/respondent/international-factors/start');
    expect(respondentCaseSequence[21].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[21].getNextStep({})).toBe('/respondent/international-factors/parents');

    expect(respondentCaseSequence[22].url).toBe('/respondent/international-factors/parents');
    expect(respondentCaseSequence[22].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[22].getNextStep({})).toBe('/respondent/international-factors/jurisdiction');

    expect(respondentCaseSequence[23].url).toBe('/respondent/international-factors/jurisdiction');
    expect(respondentCaseSequence[23].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[23].getNextStep({})).toBe('/respondent/international-factors/request');

    expect(respondentCaseSequence[24].url).toBe('/respondent/international-factors/request');
    expect(respondentCaseSequence[24].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[24].getNextStep({})).toBe('/respondent/international-factors/summary');

    expect(respondentCaseSequence[25].url).toBe('/respondent/international-factors/summary');
    expect(respondentCaseSequence[25].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[25].getNextStep({})).toBe('/respondent/task-list');

    expect(respondentCaseSequence[26].url).toBe('/respondent/safety_concerns/main_page');
    expect(respondentCaseSequence[26].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[26].getNextStep({})).toBe('/respondent/safety_concerns/your_safety');

    expect(respondentCaseSequence[27].url).toBe('/respondent/safety_concerns/your_safety');
    expect(respondentCaseSequence[27].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[27].getNextStep({})).toBe('/respondent/safety_concerns/domestic_abuse_risk');

    expect(respondentCaseSequence[28].url).toBe('/respondent/safety_concerns/domestic_abuse_risk');
    expect(respondentCaseSequence[28].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[28].getNextStep({})).toBe('/respondent/safety_concerns/domestic_abuse_risk_no');

    expect(respondentCaseSequence[29].url).toBe('/respondent/safety_concerns/domestic_abuse_risk_no');
