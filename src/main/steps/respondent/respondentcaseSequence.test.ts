...
describe('applicant1Sequence', () => {
  test('should contain 1 entries in applicant 1 screen sequence', () => {
    expect(repondentCaseSequence).toHaveLength(20);
    ...
    expect(repondentCaseSequence[10].url).toBe('/respondent/miam/willingness-to-attend-miam');
    expect(repondentCaseSequence[10].showInSection).toBe('aboutRespondentCase');
    expect(repondentCaseSequence[10].getNextStep({})).toBe('/respondent/miam/summary');

    expect(repondentCaseSequence[11].url).toBe('/respondent/miam/summary');
    ...
    expect(repondentCaseSequence[12].url).toBe('/respondent/international-factors/start');
    expect(repondentCaseSequence[12].showInSection).toBe('aboutRespondentCase');
    expect(repondentCaseSequence[12].getNextStep({})).toBe('/respondent/international-factors/parents');

    expect(repondentCaseSequence[13].url).toBe('/respondent/international-factors/parents');
    expect(repondentCaseSequence[13].showInSection).toBe('aboutRespondentCase');
    expect(repondentCaseSequence[13].getNextStep({})).toBe('/respondent/international-factors/jurisdiction');

    expect(repondentCaseSequence[14].url).toBe('/respondent/international-factors/jurisdiction');
    expect(repondentCaseSequence[14].showInSection).toBe('aboutRespondentCase');
    expect(repondentCaseSequence[14].getNextStep({})).toBe('/respondent/international-factors/request');

    expect(repondentCaseSequence[15].url).toBe('/respondent/international-factors/request');
    expect(repondentCaseSequence[15].showInSection).toBe('aboutRespondentCase');
    expect(repondentCaseSequence[15].getNextStep({})).toBe('/respondent/international-factors/summary');

    expect(repondentCaseSequence[16].url).toBe('/respondent/international-factors/summary');
    ...
    expect(repondentCaseSequence[17].url).toBe('/respondent/safety_concerns/main_page');
    expect(repondentCaseSequence[17].showInSection).toBe('aboutRespondentCase');
    expect(repondentCaseSequence[17].getNextStep({})).toBe('/respondent/safety_concerns/your_safety');

    expect(repondentCaseSequence[18].url).toBe('/respondent/safety_concerns/your_safety');
    expect(repondentCaseSequence[18].showInSection).toBe('aboutRespondentCase');
    expect(repondentCaseSequence[18].getNextStep({})).toBe('/respondent/safety_concerns/domestic_abuse_risk');

    expect(repondentCaseSequence[19].url).toBe('/respondent/safety_concerns/domestic_abuse_risk');
    expect(repondentCaseSequence[19].showInSection).toBe('aboutRespondentCase');
    expect(repondentCaseSequence[19].getNextStep({})).toBe('/respondent/safety_concerns/domestic_abuse_risk_no');

    expect(repondentCaseSequence[20].url).toBe('/respondent/safety_concerns/domestic_abuse_risk_no');
    expect(repondentCaseSequence[20].showInSection).toBe('aboutRespondentCase');
    expect(repondentCaseSequence[20].getNextStep({})).toBe('/respondent/task-list');
  });
});
