...
describe('respondent1Sequence', () => {
  test('should contain 1 entries in respondent 1 screen sequence', () => {
    ...
    expect(respondentCaseSequence[62].getNextStep({})).toBe('/task-list/respondent');
    ...
    expect(respondentCaseSequence[75].getNextStep(reasonableAdjustmentsMockData.session.userCase)).toBe(
    ...
    expect(respondentCaseSequence[76].getNextStep(reasonableAdjustmentsMockData.session.userCase)).toBe(
