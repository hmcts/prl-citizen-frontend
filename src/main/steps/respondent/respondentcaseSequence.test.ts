...
describe('respondent1Sequence', () => {
  test('should contain 1 entries in respondent 1 screen sequence', () => {
    expect(respondentCaseSequence).toHaveLength(83);
    ...
    expect(respondentCaseSequence[12].url).toBe('/respondent/confirm-contact-details/addresslookup');
    expect(respondentCaseSequence[12].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[12].getNextStep({})).toBe('/respondent/confirm-contact-details/addresslookupcont');

    expect(respondentCaseSequence[13].url).toBe('/respondent/confirm-contact-details/addresslookupcont');
    ...
    expect(respondentCaseSequence[18].url).toBe('/tasklistresponse/international-factors/start');
    expect(respondentCaseSequence[18].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[18].getNextStep({})).toBe('/tasklistresponse/international-factors/parents');

    expect(respondentCaseSequence[19].url).toBe('/tasklistresponse/international-factors/parents');
    expect(respondentCaseSequence[19].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[19].getNextStep({})).toBe('/tasklistresponse/international-factors/jurisdiction');

    expect(respondentCaseSequence[20].url).toBe('/tasklistresponse/international-factors/jurisdiction');
    expect(respondentCaseSequence[20].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[20].getNextStep({})).toBe('/tasklistresponse/international-factors/request');

    expect(respondentCaseSequence[21].url).toBe('/tasklistresponse/international-factors/request');
    expect(respondentCaseSequence[21].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[21].getNextStep({})).toBe('/tasklistresponse/international-factors/summary');

    expect(respondentCaseSequence[22].url).toBe('/tasklistresponse/international-factors/summary');
    expect(respondentCaseSequence[22].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[22].getNextStep({})).toBe('/tasklistresponse/international-factors/save');

    expect(respondentCaseSequence[23].url).toBe('/respondent/task-list');
    expect(respondentCaseSequence[23].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[23].getNextStep({})).toBe('/respondent/yourdocuments/alldocuments/orders');

    expect(respondentCaseSequence[24].url).toBe('/respondent/yourdocuments/alldocuments/orders');
    ...
    expect(respondentCaseSequence[25].getNextStep({})).toBe('/respondent/yourdocuments/alldocuments/alldocuments');

    expect(respondentCaseSequence[26].url).toBe('/respondent/yourdocuments/alldocuments/alldocuments');
    ...
    expect(respondentCaseSequence[27].url).toBe('/respondent/safety_concerns/main_page');
    expect(respondentCaseSequence[27].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[27].getNextStep({})).toBe('/respondent/safety_concerns/your_safety');

    expect(respondentCaseSequence[28].url).toBe('/respondent/safety_concerns/your_safety');
    expect(respondentCaseSequence[28].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[28].getNextStep({})).toBe('/respondent/safety_concerns/domestic_abuse_risk');

    expect(respondentCaseSequence[29].url).toBe('/respondent/safety_concerns/domestic_abuse_risk');
    expect(respondentCaseSequence[29].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[29].getNextStep({})).toBe('/respondent/safety_concerns/domestic_abuse_risk_no');

    expect(respondentCaseSequence[30].url).toBe('/respondent/safety_concerns/domestic_abuse_risk_no');
    ...
    expect(respondentCaseSequence[31].url).toBe('/respondent/proceedings/start');
    ...
    expect(respondentCaseSequence[32].url).toBe('/respondent/proceedings/court-proceedings');
    expect(respondentCaseSequence[32].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[32].getNextStep({})).toBe('/respondent/proceedings/summary');

    expect(respondentCaseSequence[33].url).toBe('/respondent/proceedings/summary');
    expect(respondentCaseSequence[33].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[33].getNextStep({})).toBe('/respondent/task-list');
  });
});
