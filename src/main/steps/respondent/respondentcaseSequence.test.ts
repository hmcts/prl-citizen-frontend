...
describe('respondent1Sequence', () => {
  test('should contain 1 entries in respondent 1 screen sequence', () => {
    expect(respondentCaseSequence).toHaveLength(86);
    ...
    expect(respondentCaseSequence[62].url).toBe('/respondent/task-list');
    expect(respondentCaseSequence[62].showInSection).toBe('aboutCaAndDaRespondentCase');
    expect(respondentCaseSequence[62].getNextStep({})).toBe(
    ...
    expect(respondentCaseSequence[64].url).toBe('/respondent/support-you-need-during-case/language-requirements');
    ...
    expect(respondentCaseSequence[65].url).toBe('/respondent/support-you-need-during-case/special-arrangements');
    ...
    expect(respondentCaseSequence[69].getNextStep({})).toBe(
    ...
    expect(respondentCaseSequence[70].getNextStep({})).toBe(
    ...
    expect(respondentCaseSequence[71].getNextStep({})).toBe('/respondent/support-you-need-during-case/summary');
    ...
    expect(respondentCaseSequence[72].getNextStep({})).toBe('/respondent/task-list');

    expect(respondentCaseSequence[73].url).toBe('/tasklistresponse/start');
    expect(respondentCaseSequence[73].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[73].getNextStep({})).toBe('/tasklistresponse/legalrepresentation/start');

    expect(respondentCaseSequence[74].url).toBe('/tasklistresponse/legalrepresentation/start');
    expect(respondentCaseSequence[74].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[74].getNextStep({})).toBe('/tasklistresponse/legalrepresentation/solicitornotdirect');
    ...
    expect(respondentCaseSequence[75].getNextStep({})).toBe('/tasklistresponse/legalrepresentation/solicitordirect');

    expect(respondentCaseSequence[76].url).toBe('/tasklistresponse/legalrepresentation/solicitordirect');
    expect(respondentCaseSequence[76].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[76].getNextStep({})).toBe('/tasklistresponse/start');
    ...
    expect(respondentCaseSequence[78].url).toBe('/respondent/yourdocuments/alldocuments/alldocuments');
    expect(respondentCaseSequence[78].showInSection).toBe('aboutRespondentCase');
    expect(respondentCaseSequence[78].getNextStep({})).toBe(
      '/respondent/yourdocuments/alldocuments/safeguarding_letter'
    );

    expect(respondentCaseSequence[79].url).toBe('/respondent/yourdocuments/alldocuments/safeguarding_letter');
    ...
    expect(respondentCaseSequence[80].getNextStep({})).toBe('/respondent/yourdocuments/alldocuments/section7_report');

    expect(respondentCaseSequence[81].url).toBe('/respondent/yourdocuments/alldocuments/section7_report');
    ...
    expect(respondentCaseSequence[82].getNextStep({})).toBe('/respondent/yourdocuments/alldocuments/section37_report');

    expect(respondentCaseSequence[83].url).toBe('/respondent/yourdocuments/alldocuments/section37_report');
    ...
    expect(respondentCaseSequence[84].getNextStep({})).toBe(
      '/respondent/yourdocuments/alldocuments/risk_assessment_16a'
    );

    expect(respondentCaseSequence[85].url).toBe('/respondent/yourdocuments/alldocuments/risk_assessment_16a');
