...
import { RESPONDENT_ADDRESS_DETAILS, RESPONDENT_ADDRESS_HISTORY, RESPONDENT_CONTACT_DETAILS, RESPONDENT_PERSONAL_DETAILS } from '../../../urls';
...
const urls = {
  ...
  applicant1PlaceOfBirth: RESPONDENT_PERSONAL_DETAILS,
