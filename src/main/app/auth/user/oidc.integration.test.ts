...
const secrets = yaml.load(fs.readFileSync('config/test.yaml', 'utf-8'));
// @ts-ignore - yaml.load returns a result of type 'unknown'
const token = secrets.auth.dummy_token;
