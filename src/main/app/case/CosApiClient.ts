...
export class CosApiClient {
  ...
  public async retrieveByCaseId(caseId: string, user: UserDetails): Promise<CaseWithId> {
    ...
    //   function (request) {
    //     console.log('45 [retrieveByCaseId] Request to server =========>' + JSON.stringify(request));
    //     return request;
    //   },
    //   function (error) {
    ...
    //console.log('45 [retrieveByCaseId] Response from server response.data ====>'+response.data);
