...
export enum CitizenNotificationId {
  CAN10_FM5 = 'CAN10_FM5',
  CAN4_SOA_PERS_NONPERS_APPLICANT = 'CAN4_SOA_PERS_NONPERS_APPLICANT',
  CAN5_SOA_RESPONDENT = 'CAN5_SOA_RESPONDENT',
  CAN8_SOS_PERSONAL_APPLICANT = 'CAN8_SOS_PERSONAL_APPLICANT',
  CAN7_SOA_PERSONAL_APPLICANT = 'CAN7_SOA_PERSONAL_APPLICANT',
  CAN9_SOA_PERSONAL_APPLICANT = 'CAN9_SOA_PERSONAL_APPLICANT',
  CAN6_VIEW_RESPONSE_APPLICANT = 'CAN6_VIEW_RESPONSE_APPLICANT',
  CRNF2_APPLICANT_RESPONDENT ='CRNF2_APPLICANT_RESPONDENT',
  CRNF3_PERS_SERV_APPLICANT = 'CRNF3_PERS_SERV_APPLICANT',
}