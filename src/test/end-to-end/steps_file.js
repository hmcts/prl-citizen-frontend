...
const RespondentTaskList = require('./pages/C100-Rebuild/RespondentTaskList');
const CourtAdmin = require('./pages/C100-Rebuild/CourtAdmin');
...
module.exports = () => {
  return actor({
    ...
    loginAsCourtAdmin1() {
      return Login.loginAsCourtAdmin1();
    },
    loginAsCourtAdmin2() {
      return Login.loginAsCourtAdmin2();
    },
    assignTaskToSelf(){
      return CourtAdmin.assignTaskToSelf();
    },
    statementOfTruth(){
      return RespondentDetails.statementOfTruth();
    },
    ...
    respondentTaskList(){
      return RespondentTaskList.respondentTaskList();
    },
    respondentAboutYou(){
      return RespondentTaskList.respondentAboutYou();
    },
    otherPersonDetails() {
