...
async ApplicantSupportDuringCase() {
    await I.retry(retryCount).click('#support_you_need_during_your_case');
    I.wait('2');
  },

  async AttendingTheCourtApplicant() {
  ...
  async languageRequirementsApplicant() {
  ...
  async SpecialArrangementsApplicant() {
  ...
  async ApplicantReasonableAdjustments1() {
  ...
  async ApplicantReasonableAdjustments2() {
  ...
  async ApplicantReasonableAdjustments3() {
  ...
  async ApplicantReasonableAdjustments4() {
  ...
  async ApplicantReasonableAdjustments5() {
  ...
  async ApplicantReasonableAdjustments6() {
  ...
  async ApplicantsummaryPage() {
    await I.retry(retryCount).waitForText('Check your answers');
    I.wait('2');
    await I.retry(retryCount).click('Save and continue');
  },

  async InternationalElementApplicant() {
    await this.clickDAApplicant();
    await this.ApplicantSupportDuringCase();
    await this.AttendingTheCourtApplicant();
    await this.languageRequirementsApplicant();
    await this.SpecialArrangementsApplicant();
    await this.ApplicantReasonableAdjustments1();
    await this.ApplicantReasonableAdjustments2();
    await this.ApplicantReasonableAdjustments3();
    await this.ApplicantReasonableAdjustments4();
    await this.ApplicantReasonableAdjustments5();
    await this.ApplicantReasonableAdjustments6()
    await this.ApplicantsummaryPage();
  }
};
