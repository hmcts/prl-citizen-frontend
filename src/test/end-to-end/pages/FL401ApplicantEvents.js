...
module.exports = {
    ...
    async eventKeepYourDetailsPrivate() {
        ...
        await I.waitForText('Does the other person named in your application (the respondent) know any of your contact details?');
        await I.checkOption('#detailsKnown');
        await I.click('Continue');

        await I.waitForText('Do you want to keep your contact details private from the other person named in the application (the respondent)?');
        await I.runAccessibilityTest();
    ...
    async eventConfirmOrEditYourContactDetails() {
        ...
        await I.fillField('#citizenUserEmailAddress', 'applicantemail@mailinator.com');
        await I.click('Continue');
    ...
    async verifyViewAllDocuments(documentsList){
        ...
        await I.waitForText("Applicant's documents");
        await I.runAccessibilityTest();
